...
$config['mongo_db']['vinplay']['hostname'] = '45.76.178.154';
$config['mongo_db']['vinplay']['port'] = '27017';
$config['mongo_db']['vinplay']['username'] = 'quantri';
$config['mongo_db']['vinplay']['password'] = 'nJjleLtZkAWADDBs3y0E1wj0GPln0UubW4tMe';
