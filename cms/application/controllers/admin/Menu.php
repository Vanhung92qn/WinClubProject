...
//select category
    ...
    function get_list_menu()
    {
        ...
        foreach ($categorys as $category) {
            ...
            $str .= "       </a>";
            $str .= "     <button data-href=" . admin_url('menu/delete/' . $category->id) . " class=\"tipS verify_action\" original-title=\"Xóa\">";
    ...
    function get_sub_list_menu($category_ids, $i = 0)
    {
        ...
        if ($sub_categorys) {
            ...
            foreach ($sub_categorys as $sub_category) {
                ...
                $str .= "      <img src=" . public_url('admin') . "/images/icons/color/edit.png>";
                $str .= "       </a>";
                $str .= "     <button data-href=" . admin_url('menu/delete/' . $sub_category->id) . " class=\"tipS verify_action\" original-title=\"Xóa\">";
                $str .= "     <img src=" . public_url('admin') . "/images/icons/color/delete.png>";
                $str .= "     </button>";
                $str .= " </td>";
                $str .= "</tr>";
