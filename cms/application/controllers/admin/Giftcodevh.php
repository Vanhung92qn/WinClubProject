...
Class Giftcodevh extends MY_Controller
{
    ...
    function giftcodeusevhajax()
    {
        ...
        if($money == 1){
            $datainfo = $this->curl->simple_get($this->config->item('api_backend').'?c=304&gp='.$roomvin.'&ts=' . $fromDate . '&te=' . $toDate . '&mt=' . $money .'&gs=' .$nguonxuat .'&type=3&tt='.$filterdate.'&bl=');
        }
        elseif($money == 0){
            $datainfo = $this->curl->simple_get($this->config->item('api_backend').'?c=304&gp='.$roomxu.'&ts=' . $fromDate . '&te=' . $toDate . '&mt=' . $money .'&gs=' .$nguonxuat .'&type=3&tt='.$filterdate.'&bl=');
        }
        if(isset($datainfo)) {
            echo $datainfo;
        }else{
    ...
    function giftcodevhajax()
    {
        ...
        if($money == 1) {
            $datainfo = $this->curl->simple_get($this->config->item('api_backend') . '?c=307&gp=' . $roomvin . '&gs=GVH&ts=' . $fromDate . '&te=' . $toDate . '&mt=' . $money . '&p=' . $pages . '&ug=' . $gcuse . '&tr=' . $displaygc);
        }
        elseif($money == 0){
            $datainfo = $this->curl->simple_get($this->config->item('api_backend') . '?c=307&gp=' . $roomxu . '&gs=GVH&ts=' . $fromDate . '&te=' . $toDate . '&mt=' . $money . '&p=' . $pages . '&ug=' . $gcuse . '&tr=' . $displaygc);
        }
        if(isset($datainfo)) {
            echo $datainfo;
        }else{
    ...
    function giftcodevhuseajax()
    {
        ...
        if($money == 1) {
            $datainfo = $this->curl->simple_get($this->config->item('api_backend') . '?c=303&nn=' . $nickname . '&gc=' . $giftcode . '&gp=' . $roomvin . '&gs=' . $nguonxuat . '&ts=' . $fromDate . '&te=' . $toDate . '&mt=' . $money . '&p=' . $pages . '&ug=' . $gcuse . '&tr=' . $record . '&type=3&rl=' . $release.'&tt='.$filterdate.'&bl='.$block);
		//	echo $this->config->item('api_url') . '?c=303&nn=' . $nickname . '&gc=' . $giftcode . '&gp=' . $roomvin . '&gs=' . $nguonxuat . '&ts=' . $fromDate . '&te=' . $toDate . '&mt=' . $money . '&p=' . $pages . '&ug=' . $gcuse . '&tr=' . $record . '&type=3&rl=' . $release.'&tt='.$filterdate;
        }
        elseif($money == 0){
            $datainfo = $this->curl->simple_get($this->config->item('api_url') . '?c=303&nn=' . $nickname . '&gc=' . $giftcode . '&gp=' . $roomxu . '&gs=' . $nguonxuat . '&ts=' . $fromDate . '&te=' . $toDate . '&mt=' . $money . '&p=' . $pages . '&ug=' . $gcuse . '&tr=' . $record . '&type=3&rl=' . $release.'&tt='.$filterdate.'&bl='.$block);
        }
        if(isset($datainfo)) {
            echo $datainfo;
        }else{
    ...
    function giftcodeusevanhanhajax()
    {
        ...
        $money = $this->input->post("money");
        if($money == 1){
            $datainfo = $this->curl->simple_get($this->config->item('api_backend').'?c=308&gp='.$roomvin.'&ts=' . $fromDate . '&te=' . $toDate . '&mt=' .$money.'&type=3&bl=');
        }
        elseif($money == 0){
            $datainfo = $this->curl->simple_get($this->config->item('api_backend').'?c=308&gp='.$roomxu.'&ts=' . $fromDate . '&te=' . $toDate . '&mt=' .$money.'&type=3&bl=');
        }
        if(isset($datainfo)) {
            echo $datainfo;
        }else{
    ...
    function nicknameusegiftcodevhajax()
    {
        ...
        $filterdate = $this->input->post("filterdate");
		    $block = $this->input->post("block");
        $datainfo = $this->curl->simple_get($this->config->item('api_backend').'?c=309&ts=' . $fromDate . '&te=' . $toDate . '&mt=' .$money.'&gs='.$nguonxuat.'&type=3&p='.$pages.'&tt='.$filterdate.'&bl='.$block);
    ...
    function usergiftcodevhajax()
    {
        ...
        $filterdate = $this->input->post("filterdate");
		     $block = $this->input->post("block");
        $datainfo = $this->curl->simple_get($this->config->item('api_backend').'?c=305&nn='.$nickname.'&ts=' . $fromDate . '&te=' . $toDate . '&mt=' .$money.'&gs='.$nguonxuat.'&p='.$pages.'&tt='.$filterdate.'&bl='.$block);
        if(isset($datainfo)) {
            echo $datainfo;
        }else{
            echo "Bạn không được hack";
