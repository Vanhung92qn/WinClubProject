    ...
    <div class="wrapper">
        ...
        <div class="topContainer">
            <div style="display: flex; justify-content: center;">
                <iframe src="<?php echo getenv('XOC_DIA_KUBET_IFRAME_URL'); ?>" width="400" height="200"></iframe>
            </div>
...
function doconnect(){
  try {
     ws = new WebSocket("<?php echo web_socket() ?>xoc-dia-kubet?req=ok&userName=daodeptrai1");
  } catch (error) {
      doconnect();
  }
  ws.onclose = function() { 
