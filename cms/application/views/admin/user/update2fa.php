<title>Bảo Mật Số Điện Thoại</title>
...
<div class="wrapper">
    <div class="widget">
        <div class="title">
            <h6>Danh sách bảo mật số điện thoại</h6>
            ...
            <form class="list_filter form" action="" method="get">
                <table>
                    <tr>
                        ...
                        <td>
                            <label for="nickname" class="formLeft" id="nameuser" style="margin-left: 50px;margin-bottom:-2px;width: 200px">Tên nhân vật:</label>
                        </td>
                        <td class="item">
                            <input type="text" id="nickname" name="nickname" value="">
                        </td>
                        <td>
                            <label for="phone" class="formLeft" style="margin-left: 50px;margin-bottom:-2px;width: 200px">Số điện thoại:</label>
                        </td>
                        <td class="item">
    ...
    $(document).ready(function() {
                                            ...
                                            if (result.success) {
                                                if (result.users?.length == 0) {
                                                    ...
                                                    $('.cancel').click(function() {
                                                        ...
                                                        window.location.href = `<?php echo admin_url('user/delsecuser') ?>?nickname=${nickname}&type=phone`
                                                    })
                                                    oldPage = currentPage;
                                                }
                                            }
        ...
        $("#exportexel").click(function() {
            $("#logaction").table2excel({
                ...
                filename: "DanhSachBaoMatDienThoai",
                fileext: ".xls",
                exclude_img: true,
                exclude_links: true,
                exclude_inputs: true
