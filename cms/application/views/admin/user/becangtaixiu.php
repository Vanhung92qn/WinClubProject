...
<script>
    ...
    function updateSetBot(moneyMin, moneyMax, numberUserTaiMax, numberUserXiuMax) {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo base_url("admin/user/updateSetBot") ?>",
            data: {
                moneyMin: moneyMin,
                moneyMax: moneyMax,
    ...
    function getBotInfo() {
        $.ajax({
            type: "GET",
            url: "<?php echo base_url("admin/user/getInforSetBot") ?>",
            success: function (result) {
                if (result == 0) {
...
function doconnect(){
  try {
    ws = new WebSocket("<?php echo web_socket() ?>taixiu") // ket noi ws server
