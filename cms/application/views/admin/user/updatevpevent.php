                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        <div class="row">
                            <div class="col-sm-4"></div>
                            <div class="col-sm-1">
                                <input type="button" id="updatevp" value="Update" class="btn btn-primary pull-left">
                            </div>
                        </div>
                    </div>
    ...
    $.ajax({
        ...
        success: function(result) {
            ...
            if (result == 0) {
                ...
                $("#errorupdate").html("Mã otp sai");
            } else if (result == 1021) {
                $("#errorupdate").html("Mã otp hết hạn");
            } else if (result == 1001) {
                $("#errorupdate").html("Hệ thống gián đoạn hoặc nickname không tồn tại");
            }
        }
    });
