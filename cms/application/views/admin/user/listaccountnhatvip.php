...
<div class="wrapper">
    ...
    <div class="widget" style="background: #82d1ff; border-radius: 15px;">
        ...
        <div class="title">
            <h6 style="color: #001f0f;">DANH SÁCH ACC Nhatvip</h6>
        </div>
            ...
            <div Class="Content-table">
                <div class="Content-table-item">
                    <div class="Content-table-item__ttl formRow">
                        <h4>DANH DÁCH TÀI KHOẢN Nhatvip</h4>
                    </div>
        ...
        <div style='position: relative;'>
            <div Class="Content-table">
                <div class="Content-table-item">
                    <div class="Content-table-item__ttl formRow">
                        <h4>DANH DÁCH TÀI KHOẢN Nhatvip CHƯA CÓ NICKNAME</h4>
                    </div>
...
<script>
    ...
    function Delete(id, username, timelog) {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo base_url("admin/user/DeleteAccountNhatvipAjax") ?>",
            data: {
                username: username,
                timelog: timelog
            },
    ...
    function renderlistAccByTime() {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo base_url("admin/user/listAccountNhatvipByTimeAjax") ?>",
            data: {
                page: 0,
                maxitem: 5000,
