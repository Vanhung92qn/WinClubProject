...
<?php else: ?>
    <div class="wrapper">
        ...
        <div class="widget" style="background: #ffd6d6; border-radius: 15px;">
            ...
            <div class="title">
                <h6 style="color: #7b0000;">Cập nhật Kèo Bóng Đá</h6>
            </div>
                        ...
                        <tr>
                            <td>
                                <input type="button"
                                       ...
                                       value="<<Quay lại" class="basic" style="margin-left: 20px ;background-color: #00b5d2!important; margin-bottom: 20px">
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td><input type="hidden"
                                       ...
                                       id="idtran" value="<?php echo $idtran ?>" name="idtran"></td>
                            <td><input type="hidden"
                                       style="margin-left: 20px;margin-bottom:-2px;width: 150px; margin-top: 6px;"
                                       id="session" value="<?php echo $_GET['session'] ?>" name="idtran"></td>
                ...
                <div class="formRow">
                    ...
                    <table>
                        <tr>
                            ...
                            <td><input type="text"
                                       style="margin-left: 20px;margin-bottom:-2px;width: 150px; margin-top: 6px;"
                                       id="doiA" value="<?php echo $_GET['doiA'] ?>" name="name"></td>
                            ...
                            <td><input type="text"
                                       style="margin-left: 20px;margin-bottom:-2px;width: 150px; margin-top: 6px;"
                                       id="doiB" value="<?php echo $_GET['doiB'] ?>" name="name"></td>
                        </tr>
                        <tr>
                            ...
                            <td><input type="text"
                                       ...
                                       id="banThangDoiA" value="<?php echo $_GET['banThangDoiA'] ?>"
                                       name="name"></td>
                            <td><label style="margin-left: 30px;margin-bottom:-2px;margin-top: 5px;">Bàn thắng Đội
                                    B:</label></td>
                            ...
                            <td><input type="text"
                                       style="margin-left: 20px;margin-bottom:-2px;width: 150px; margin-top: 5px;"
                                       id="banThangDoiB" value="<?php echo $_GET['banThangDoiB'] ?>"
                                       name="name"></td>
                        </tr>
                        <tr>
                            ...
                            <td><input type="text"
                                       ...
                                       value="<?php echo $_GET['tiLeDoiAChapCaTran'] ?>" name="name"></td>
                            ...
                            <td><input type="text"
                                       ...
                                       value="<?php echo $_GET['tiLeDoiBChapCaTran'] ?>" name="name"></td>
                        </tr>
                        <tr>
                            ...
                            <td><input type="text"
                                       style="margin-left: 20px;margin-bottom:-2px;width: 150px;margin-top: 5px;"
                                       id="tileAnDoiACaTran"
                                       value="<?php echo $_GET['tileAnDoiACaTran'] ?>" name="name"></td>
                            ...
                            <td><input type="text"
                                       style="margin-left: 20px;margin-bottom:-2px;width: 150px ;margin-top: 5px;"
                                       id="tileAnDoiBCaTran"
                                       value="<?php echo $_GET['tileAnDoiBCaTran'] ?>" name="name"></td>
                        </tr>
                        <tr>
                            <td><label style="margin-left: 30px;margin-bottom:-2px;margin-top: 5px;">Tỉ lệ đội A Chấp
                                    tài xỉu:</label></td>
                            ...
                            <td><input type="text"
                                       ...
                                       value="<?php echo $_GET['tileDoiAChapTaiXiu'] ?>" name="name"></td>
                            ...
                            <td><input type="text"
                                       ...
                                       value="<?php echo $_GET['tileDoiBChapTaiXiu'] ?>" name="name"></td>
                        </tr>
                        <tr>
                            ...
                            <td><input type="text"
                                       style="margin-left: 20px;margin-bottom:-2px;width: 150px;margin-top: 5px;"
                                       id="tileAnDoiATaiXiu"
                                       value="<?php echo $_GET['tileAnDoiATaiXiu'] ?>" name="name"></td>
                            ...
                            <td><input type="text"
                                       style="margin-left: 20px;margin-bottom:-2px;width: 150px ;margin-top: 5px;"
                                       id="tileAnDoiBTaiXiu"
                                       value="<?php echo $_GET['tileAnDoiBTaiXiu'] ?>" name="name"></td>
                        </tr>
                        <tr>
                            <td><label style="margin-left: 30px;margin-bottom:-2px;margin-top: 5px;">Tỉ lệ đội A Chấp
                                    Hiệp 1:</label></td>
                            ...
                            <td><input type="text"
                                       ...
                                       value="<?php echo $_GET['tileDoiAChapHiep1'] ?>" name="name"></td>
                            ...
                            <td><input type="text"
                                       ...
                                       value="<?php echo $_GET['tileDoiBChapHiep1'] ?>" name="name"></td>
                        </tr>
                        <tr>
                            ...
                            <td><input type="text"
                                       style="margin-left: 20px;margin-bottom:-2px;width: 150px;margin-top: 5px;"
                                       id="tileAnDoiAHiep1" value="<?php echo $_GET['tileAnDoiAHiep1'] ?>"
                                       name="name"></td>
                            ...
                            <td><input type="text"
                                       style="margin-left: 20px;margin-bottom:-2px;width: 150px ;margin-top: 5px;"
                                       id="tileAnDoiBHiep1" value="<?php echo $_GET['tileAnDoiBHiep1'] ?>"
                                       name="name"></td>
                        </tr>
                        <tr>
                            <td><label style="margin-left: 30px;margin-bottom:-2px;margin-top: 5px;">Tỉ lệ đội A Chấp
                            ...
                            <td><input type="text"
                                       ...
                                       value="<?php echo $_GET['tileDoiAChapHiep2'] ?>" name="name"></td>
                            ...
                            <td><input type="text"
                                       ...
                                       value="<?php echo $_GET['tileDoiBChapHiep2'] ?>" name="name"></td>
                        </tr>
                        <tr>
                            <td><label style="margin-left: 30px;margin-bottom:-2px;margin-top: 5px;">Tỉ lệ đội A Ăn Hiệp
                                    2:</label></td>
                            ...
                            <td><input type="text"
                                       style="margin-left: 20px;margin-bottom:-2px;width: 150px;margin-top: 5px;"
                                       id="tileAnDoiAHiep2" value="<?php echo $_GET['tileAnDoiAHiep2'] ?>"
                                       name="name"></td>
                            ...
                            <td><input type="text"
                                       style="margin-left: 20px;margin-bottom:-2px;width: 150px ;margin-top: 5px;"
                                       id="tileAnDoiBHiep2" value="<?php echo $_GET['tileAnDoiBHiep2'] ?>"
                                       name="name"></td>
                        </tr>
...
<script>
    ...
    $("#search_tran").click(function () {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo admin_url('user/updatekeoajax')?>",
            data: {
                id: id,
                doiA: doiA,
                doiB: doiB,
            ...
            success: function (result) {
                ...
                if (result == "1") {
                    ...
                    window.location.href = "<?php echo admin_url('user/listkeobongda')?>";
                } else {
