<!-- head -->
<title>Log Mở Khóa Tài Khoản</title>
                ...
                <div class="formRow">
                    <table>
                        <tr>
                            ...
                            <td>
                                <label for="param_name" style="width: 100px;margin-bottom:-3px;margin-left: 43px;" class="formLeft">Hành động: </label>
                            </td>
                            <td><input type="text" style="margin-left: 27px;margin-bottom:-2px;width: 150px" id="txtaction" value="<?php echo $this->input->post('txtaction') ?>" name="txtaction"></td>
                ...
                <div class="formRow">
                    <table>
                        <tr>
                            ...
                            <td><input type="text" style="margin-left: 20px;margin-bottom:-2px;width: 150px" id="txtname" value="<?php echo $this->input->post('txtname') ?>" name="txtname">
                            </td>
                            <td>
                                <label for="param_name" style="width: 100px;margin-bottom:-3px;margin-left: 43px;" class="formLeft">Lý do: </label>
                            </td>
                            <td><input type="text" style="margin-left: 27px;margin-bottom:-2px;width: 150px" id="txtlydo" value="<?php echo $this->input->post('txtlydo') ?>" name="txtlydo"></td>
                ...
                <div class="formRow">
                    <table>
                        <tr>
                            ...
                            <td class="">
                                <select id="lockstatus" name="status" style="margin-left: 0px;margin-bottom:-2px;width: 143px">
                            ...
                            <td>
                                <input type="reset" onclick="window.location.href = '<?php echo admin_url('actionadmin') ?>'; " value="Reset" class="basic" style="margin-left: 20px">
                            </td>
                        </tr>
                    </table>
