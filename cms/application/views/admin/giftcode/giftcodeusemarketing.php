...
<section class="content-header">
    <h1>
        Thống kê giftcode trong kho marketing
    </h1>
</section>
                    ...
                    <div class="form-group">
                        ...
                        <span class="glyphicon glyphicon-calendar"></span>
                            ...
                            <div class="col-sm-1"><input type="reset" value="Reset" name="submit"
                                                         class="btn btn-primary pull-left" id="reset"  onclick="window.location.href = '<?php echo base_url('giftcode/giftcodeusemarketing') ?>'; "></div>
                            </div>
                        </div>
                    <div class="col-sm-12">
...
<script>
    ...
    $("#search_tran").click(function () {
        ...
        if($("#money").val()==1){
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo base_url("giftcode/giftcodeusemarketingajax") ?>",
                data: {
                    roomvin: $("#roomvin").val(),
