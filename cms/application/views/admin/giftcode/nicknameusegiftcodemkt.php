...
<section class="content-header">
    <h1>
        Thống kê giftcode đã dùng theo nguồn marketing
    </h1>
                    ...
                    <div class="form-group">
                        ...
                        <span class="glyphicon glyphicon-calendar"></span>
                            ...
                            <div class="col-sm-1"><input type="reset" value="Reset" name="submit"
                                                         class="btn btn-primary pull-left" id="reset"  onclick="window.location.href = '<?php echo base_url('giftcode/nicknameusegiftcodemkt') ?>'; "></div>
                            </div>
                        </div>
                    <div class="col-sm-12">
...
<script>
    ...
    $("#search_tran").click(function () {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo base_url("giftcode/nicknameusegiftcodemktajax") ?>",
            data: {
