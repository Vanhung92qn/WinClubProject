                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-sm-1"><input type="reset" value="Reset" name="submit"
                                                         ...
                                                         onclick="window.location.href = '<?php echo base_url('giftcode/mktaddgc') ?>'; ">
                            </div>
                        </div>
                    </div>
...
<script>
    ...
    $("#search_tran").click(function () {
        ...
        if ($("#soluong").val() == "") {
            ...
            $("#errornx").html("");
            return false;
        }else if($("#soluong").val() > 100000){
            $("#errorsl").html("");
            $("#errornx").html("");
            $("#errorph").html("");
            $("#errorgift").html("Bạn chỉ được xuất 100,000 giftcode");
            $("#successgift").html("");
            return false;
        }
        if ($("#money").val() == 1) {
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo base_url('giftcode/mktaddgcajax') ?>",
                data: {
                    money: $("#roomvin").val(),
