        ...
        <div class="widget">
            ...
            <form class="list_filter form">
                ...
                <div class="formRow">
                    <table>
                        <tr>
                            ...
                            <td class="item">
                                <select id="nguonxuat" name="nguonxuat" style="margin-left: 13px;margin-bottom:-2px;width: 150px">
                ...
                <div class="formRow">
                    <table>
                        <tr>
                            <td><label style="margin-left: 84px;margin-bottom:-2px;width: 64px">Tiền:</label></td>
                            <td class="">
                                <select id="money" name="money" style="margin-left: 20px;margin-bottom:-2px;width: 150px">
                            ...
                            <td>
                                <input type="reset" onclick="window.location.href = '<?php echo admin_url('giftcode/giftcodemktuse') ?>'; " value="Reset" class="basic" style="margin-left: 20px">
                            </td>
                        </tr>
                    </table>
                </div>
...
<script>
    ...
    function giftcodexu() {
        ...
        $.ajax({
            ...
            success: function(result1) {
                ...
                result += "</tr>";
                result += "<tr>";
                result += "<td rowspan='" + ii + "' style='vertical-align: middle;color:#7a6fbe;text-align: center;background: #e8e2e2;font-weight: 700; font-size: 20px'>" + "Đại lý" + "</td>";
                result += "</tr>";
                ...
                result += "</tr>";
                result += "<tr>";
                result += "<td rowspan='" + jj + "' style='vertical-align: middle;color:#7a6fbe;text-align: center;background: #e8e2e2;font-weight: 700; font-size: 20px'>" + "Marketing" + "</td>";
                result += "</tr>";
                ...
                result += "</tr>";
                result += "<tr>";
                result += "<td rowspan='" + kk + "' style='vertical-align: middle;color:#7a6fbe;text-align: center;background: #e8e2e2;font-weight: 700; font-size: 20px'>" + "Vận hành" + "</td>";
                result += "</tr>";
    ...
    function sumresult(quantity, use, lock, money) {
        ...
        rs += "<td style='color: #7a6fbe;font-size: 20px;font-weight:700;text-align: right'>" + "Tổng" + "</td>";
    ...
    function sumresulttong(quantity, use, lock, money) {
        ...
        rs += "<td colspan='2' style='color: #7a6fbe;font-size: 20px;font-weight:700;text-align: right'>" + "Tổng" + "</td>";
        rs += "<td style='color: blue;font-size: 20px;font-weight:700;text-align: right;'>" + commaSeparateNumber(quantity) + "</td>";
        rs += "<td style='color: blue;font-size: 20px;font-weight:700;text-align: right'>" + commaSeparateNumber(use) + "</td>";
        rs += "<td style='color: blue;font-size: 20px;font-weight:700;text-align: right'>" + commaSeparateNumber(money) + "</td>";
        rs += "<td style='color: blue;font-size: 20px;font-weight:700;text-align: right'>" + commaSeparateNumber(lock) + "</td>";
