    ...
    <div class="wrapper">
        ...
        <div class="widget">
            ...
            <div class="formRow">
                <div class="row">
                    <div class="col-sm-4"></div>
                    <label class="col-sm-4" style="color: #e72929;word-break: break-all" id="errocodeuse">
                    </label>
            ...
            <div class="formRow">
                ...
                <td><label style="margin-left: 50px;margin-bottom:-2px;width: 100px">Hiển thị:</label></td>
                <td class="">
