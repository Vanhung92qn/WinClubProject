                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-xs-3 col-sm-3 col-md-2">
                                    <input type="text" id="txtotp" placeholder="Nhập mã otp" class="form-control" maxlength="6">
                                </div>
                            </div>
                        </div>
                        <?php } ?>
						<div class="form-group">
                            <div class="row">
                                <div class="col-xs-2 col-sm-2 col-md-2"></div>
                                <label id="labelvin" class="col-xs-2 col-sm-2 col-md-1 control-label">Ngày thực hiện:</label>
                                <div class="col-xs-3 col-sm-3 col-md-2">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-2">
                                    <input type="button" id="refundfeeagent"
                                           value="Hoàn trả phí tháng trước" class="btn btn-primary pull-left">
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-sm-2">
                                    <input type="button" id="bonusagent"
                                           value="Thưởng doanh số tháng trước" class="btn btn-primary pull-left">
                                </div>
                            </div>
                        </div>
