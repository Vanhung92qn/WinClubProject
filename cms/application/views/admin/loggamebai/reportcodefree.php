            ...
            <form class="list_filter form" action="<?php echo admin_url('loggamebai/reportcodefree') ?>" method="post">
                ...
                <div class="formRow">
                    ...
                    <table>
                        <tr>
                            ...
                            <td><input type="text" style="margin-left: -50px;margin-bottom:-2px;width: 150px" id="txt_id" value="<?php echo $this->input->post('txt_id') ?>" name="txt_id">
                            </td>
                ...
                <div class="formRow">
                    <table>
                        <tr>
                            <td>
                                <label for="param_name" style="width: 120px;margin-bottom:-3px;margin-left: 100px;" class="formLeft">Code: </label>
                            </td>
                            <td><input type="text" style="margin-left: -50px;margin-bottom:-2px;width: 150px" id="txt_code" value="<?php echo $this->input->post('txt_code') ?>" name="txt_code">
                            </td>

                            <td>
                                <label for="param_name" style="width: 115px;margin-bottom:-3px;margin-left: 47px;" class="formLeft">Giá trị code: </label>
                            </td>
                            <td class="item"><select id="select_gtcode" name="select_gtcode" style="margin-left: 5px;margin-bottom:-2px;width: 150px">
                ...
                <div class="formRow">
                    <table>
                        <tr>
                            ...
                            <td>
                                <label for="param_name" style="width: 115px;margin-bottom:-3px;margin-left: 47px;" class="formLeft">Trạng thái: </label>
                            </td>

                            <td class="item"><select id="select_tt" name="select_tt" style="margin-left: 5px;margin-bottom:-2px;width: 150px">
                            ...
                            <td>
                                <label for="param_name" style="width: 115px;margin-bottom:-3px;margin-left: 47px;" class="formLeft"> Tìm theo: </label>
                            </td>
                            <td class="item"><select id="search_type" name="search_type" style="margin-left: 5px;margin-bottom:-2px;width: 150px">
                ...
                <div class="formRow">
                    <table>
                        <tr>
                            ...
                            <td><input type="text" style="margin-left: 20px;margin-bottom:-2px;width: 150px" id="txt_loid" value="<?php echo $this->input->post('txt_loid') ?>" name="txt_loid">
                            </td>
                            <td><label style="margin-left: 47px;margin-bottom:-2px;width: 100px">Loại Code:</label></td>
                            <td><select id="typecode" name="typecode" style="margin-left: 30px;margin-bottom:-2px;width: 150px">
                ...
                <div class="formRow">
                    <table>
                        <tr>
                            ...
                            <td><input type="text" style="margin-left: 18px;margin-bottom:-2px;width: 150px" id="txt_thongtin" value="<?php echo $this->input->post('txt_thongtin') ?>" name="txt_thongtin">
                            </td>
