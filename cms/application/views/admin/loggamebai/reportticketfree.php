            ...
            <form class="list_filter form" action="<?php echo admin_url('loggamebai/reportticketfree') ?>" method="post">
                ...
                <div class="formRow">
                    <table>
                        <tr>
                            <td>
                                <label for="param_name" style="width: 120px;margin-bottom:-3px;margin-left: 23px;" class="formLeft">Nguồn tạo: </label>
                            </td>
                            <td class="item"><select id="select_source" name="select_source" style="margin-left: 27px;margin-bottom:-2px;width: 142px">
                            ...
                            <td>
                                <label for="param_name" style="width: 115px;margin-bottom:-3px;margin-left: 47px;" class="formLeft">Giá trị vé: </label>
                            </td>
                            <td class="item"><select id="select_gtve" name="select_gtve" style="margin-left: 5px;margin-bottom:-2px;width: 150px">
                                    <option value="-1">Chọn</option>
                ...
                <div class="formRow">
                    <table>
                        <tr>
                            ...
                            <td><input type="text" style="margin-left: 20px;margin-bottom:-2px;width: 150px" id="txt_tourid" value="<?php echo $this->input->post('txt_tourid') ?>" name="txt_tourid">
                            </td>
                            <td><label style="margin-left: 47px;margin-bottom:-2px;width: 100px">Loại Tour:</label></td>
                            <td><select id="typetour" name="typetour" style="margin-left: 30px;margin-bottom:-2px;width: 150px">
