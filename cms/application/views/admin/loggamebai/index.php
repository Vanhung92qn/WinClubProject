                    ...
                    <table>
                        <tr>
                            ...
                            <td><select id="namegame" name="namegame" style="margin-left: 27px;margin-bottom:-2px;width: 142px">
                                    <option value="" <?php if ($this->input->post('namegame') == "") {
                                                            echo "selected";
                                                        } ?>>
                                        Chọn</option>
                                    ...
                                    <option value="Tala" <?php if ($this->input->post('namegame') == "Tala") {
                                                                echo "selected";
                                                            } ?>>Tá Lả
                                    </option>
                                    ...
                                    <option value="XiTo" <?php if ($this->input->post('namegame') == "XiTo") {
                                                                echo "selected";
                                                            } ?>>Xì Tố
                                    </option>
                                    ...
                                    <option value="PokerTour" <?php if ($this->input->post('namegame') == "PokerTour") {
                                                                    echo "selected";
                                                                } ?>>
                                        PokerTour</option>
                                    <option value="XiDzach" <?php if ($this->input->post('namegame') == "XiDzach") {
                                                                echo "selected";
                                                            } ?>>XiDzach
                                    </option>

                                    <option value="Caro" <?php if ($this->input->post('namegame') == "Caro") {
                                                                echo "selected";
                                                            } ?>>Caro
                                    </option>
                                    <option value="Cotuong" <?php if ($this->input->post('namegame') == "CoTuong") {
                                                                echo "selected";
                                                            } ?>>Cờ tướng
                                    </option>
                                    <option value="CoUp" <?php if ($this->input->post('namegame') == "CoUp") {
                                                                echo "selected";
                                                            } ?>>Cờ úp
                                    </option>
                                </select></td>
                ...
                <div class="formRow">
                    ...
                    <table>
                        <tr>
                            ...
                            <td><input type="text" style="margin-left: 20px;margin-bottom:-2px;width: 150px" id="session_name" value="<?php echo $this->input->post('session_name') ?>" name="session_name"></td>
                            <td><label style="margin-left: 50px;margin-bottom:-2px;width: 80px">Loại tiền:</label></td>
                            ...
                            <td>
                                <input type="reset" onclick="window.location.href = '<?php echo admin_url('loggamebai') ?>'; " value="Reset" class="basic" style="margin-left: 20px">
                            </td>
                        </tr>
                    </table>
                </div>
...
<script>
            ...
            success: function(result) {
                ...
                if (result.transactions == "") {
                    ...
                    $.each(result.transactions, function(index, value) {
                        result += resultSearchTransction(stt, value.sessionId, value.nickName,
                            value.gameName, value.moneyType, value.timeLog);
                        stt++;
                    });
    ...
    function resultSearchTransction(stt, sid, nickname, gamename, moneytype, time) {
        ...
        rs += "<td><a style='color: #7a6fbe' href='loggamebai/detail/" + sid + "/" + gamename + "/" + time + "'>" +
            nickname + "</a>" + "</td>";
        rs += "<td>" + gamename + "</td>";
