...
<script>
    ...
    function resultSum(total, totalInactive, totalUsed, totalLocked, totalExpired, totalRemain) {
        ...
        var rs = "";
        rs += "<tr>";
        rs += "<td style='color: #7a6fbe ;font-weight: 600'>" + "Tổng" + "</td>";
        rs += "<td style='color: #7a6fbe ;font-weight: 600'>" + commaSeparateNumber(total) + "</td>";
        rs += "<td style='color: #7a6fbe ;font-weight: 600'>" + commaSeparateNumber(totalInactive) + "</td>";
        rs += "<td style='color: #7a6fbe ;font-weight: 600'>" + commaSeparateNumber(totalUsed) + "</td>";
        rs += "<td style='color: #7a6fbe ;font-weight: 600'>" + commaSeparateNumber(totalLocked) + "</td>";
        rs += "<td style='color: #7a6fbe ;font-weight: 600'>" + commaSeparateNumber(totalExpired) + "</td>";
        rs += "<td style='color: #7a6fbe ;font-weight: 600'>" + commaSeparateNumber(totalRemain) + "</td>";
        rs += "</tr>";
        return rs;
    }
            ...
            success: function(res) {
                ...
                if (res == "") {
                    ...
                    if (res[10000]) {
                        ...
                        total1 += res[10000].total;
                        total2 += res[10000].totalInactive;
                        total3 += res[10000].totalUsed;
                        total4 += res[10000].totalLocked;
                        total5 += res[10000].totalExpired;
                        total6 += res[10000].totalRemain;
                    } else {
                    ...
                    if (res[50000]) {
                        ...
                        total1 += res[50000].total;
                        total2 += res[50000].totalInactive;
                        total3 += res[50000].totalUsed;
                        total4 += res[50000].totalLocked;
                        total5 += res[50000].totalExpired;
                        total6 += res[50000].totalRemain;
                    } else {
                    ...
                    if (res[100000]) {
                        ...
                        total1 += res[100000].total;
                        total2 += res[100000].totalInactive;
                        total3 += res[100000].totalUsed;
                        total4 += res[100000].totalLocked;
                        total5 += res[100000].totalExpired;
                        total6 += res[100000].totalRemain;
                    } else {
                    ...
                    if (res[200000]) {
                        ...
                        total1 += res[200000].total;
                        total2 += res[200000].totalInactive;
                        total3 += res[200000].totalUsed;
                        total4 += res[200000].totalLocked;
                        total5 += res[200000].totalExpired;
                        total6 += res[200000].totalRemain;
                    } else {
