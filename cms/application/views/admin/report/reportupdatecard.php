    ...
    <div class="wrapper">
        ...
        <div class="widget">
            ...
            <div class="formRow">
                ...
                <div class="row">
                    <div class="col-sm-2">
                        <h5>Viettel:<span style="color: #7a6fbe" id="money1"></span></h5>
                    </div>
                    <div class="col-sm-2">
                        <h5>Vinaphone:<span style="color: #7a6fbe" id="money2"></span></h5>
                    </div>
                    <div class="col-sm-2">
                        <h5>Mobifone:<span style="color: #7a6fbe" id="money3"></span></h5>
                    </div>
                    <div class="col-sm-2">
                        <h5>Gate:<span style="color: #7a6fbe" id="money6"></span></h5>
                    </div>
