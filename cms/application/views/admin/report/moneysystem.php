            ...
            <div class="formRow">
                <table>
                    <tr>
                        ...
                        <td>
                            <input type="reset" onclick="window.location.href = '<?php echo admin_url('report/moneysystem') ?>'; " value="Reset" class="basic" style="margin-left: 20px">
                        </td>
                    </tr>
                </table>
            </div>
        ...
        <div class="widget">
            ...
            <div id="widget">
                ...
                <div class="formRow">
                    <div class="row">
                        <div class="col-sm-3">
                            <h5>Tiền sự kiện: <span id="spanevent" style="color: #7a6fbe"></span></h5>
                        </div>
                        <div class="col-sm-3">
                            <h5>Phế: <span id="spanphe" style="color: #7a6fbe"></span></h5>
                        </div>
                        <div class="col-sm-3">
                            <h5>Tiền thắng trong game: <span id="spanmoneygame" style="color: #7a6fbe"></span></h5>
                        </div>
                        <div class="col-sm-3">
                            <h5>Tiền thắng tổng: <span id="spanmoney" style="color: #7a6fbe"></span></h5>
                        </div>
                    </div>
                </div>
                ...
                <div class="formRow">
                    <div class="row">
                        <h4 id="" style="color: #e72929;margin-left: 10px">Tiền nạp game (VNĐ)</h4>
                    </div>
                </div>
                <div class="formRow">
                    <div class="row">
                        ...
                        <div class="col-xs-12">
                            <table class="table table-bordered" style="table-layout: fixed">
                                ...
                                <tbody>
                                    <tr>
                                        <td colspan="2">Tổng:</td>
                                        <td id="totalmoneywinbotbai" style="color: #7a6fbe"></td>
                                        <td id="totalmoneylostbotbai" style="color:#7a6fbe "></td>
                                        <td id="totalmoneyotherbotbai" style="color: #7a6fbe"></td>
                                        <td id="totalmoneyfeebotbai" style="color: #7a6fbe"></td>
                                        <td id="totalmoneyplaybotbai" style="color: #7a6fbe"></td>
                                        <td id="totalmoneybotbai" style="color: #7a6fbe"></td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
...
<script>
    ...
    function resulttranfer(moneyother, fee) {
        ...
        var rs = "";
        rs += "<tr>";
        rs += "<td style='color: #7a6fbe'>" + commaSeparateNumber(moneyother) + "</td>";
        rs += "<td style='color: #7a6fbe'>" + commaSeparateNumber(fee) + "</td>";
        rs += "</tr>";
        return rs;
    }
    ...
    function resulttotalvinin(rechargeiap, rechargecard, rechargebank, vqmm, giftcode, cashoutvp, refundfee, vippointevent, bonustopds, rechargesms, total) {
        var rs = "";
        rs += "<tr>";
        rs += "<td style='color: #7a6fbe'>" + commaSeparateNumber(rechargeiap) + "</td>";
        rs += "<td style='color: #7a6fbe'>" + commaSeparateNumber(rechargecard) + "</td>";
        rs += "<td style='color: #7a6fbe'>" + commaSeparateNumber(rechargebank) + "</td>";
        rs += "<td style='color: #7a6fbe'>" + commaSeparateNumber(rechargesms) + "</td>";
        rs += "<td style='color: #7a6fbe'>" + commaSeparateNumber(vqmm) + "</td>";
        rs += "<td style='color: #7a6fbe'>" + commaSeparateNumber(giftcode) + "</td>";
        rs += "<td style='color: #7a6fbe'>" + commaSeparateNumber(cashoutvp) + "</td>";
        rs += "<td style='color: #7a6fbe'>" + commaSeparateNumber(refundfee) + "</td>";
        rs += "<td style='color: #7a6fbe'>" + commaSeparateNumber(vippointevent) + "</td>";
        rs += "<td style='color: #7a6fbe'>" + commaSeparateNumber(bonustopds) + "</td>";
    ...
    function resulttotalvinout(cashoutcard, cashouttopup, vin2xu, chargesms, fee, gcagent, total) {
        ...
        var rs = "";
        rs += "<tr>";
        rs += "<td style='color: #7a6fbe'>" + commaSeparateNumber(cashoutcard) + "</td>";
        rs += "<td style='color: #7a6fbe'>" + commaSeparateNumber(cashouttopup) + "</td>";
        rs += "<td style='color: #7a6fbe'>" + commaSeparateNumber(vin2xu) + "</td>";
        rs += "<td style='color: #7a6fbe'>" + commaSeparateNumber(chargesms) + "</td>";
        rs += "<td style='color: #7a6fbe'>" + commaSeparateNumber(fee) + "</td>";
        rs += "<td style='color: #7a6fbe'>" + commaSeparateNumber(gcagent) + "</td>";
        rs += "<td style='color: #7a6fbe'>" + commaSeparateNumber(total) + "</td>";
        rs += "</tr>";
        return rs;
    }
    ...
    function resulttotalinitital(superagent, bot, total) {
        ...
        var rs = "";
        rs += "<tr>";
        rs += "<td style='color: #7a6fbe'>" + commaSeparateNumber(superagent) + "</td>";
        rs += "<td style='color: #7a6fbe'>" + commaSeparateNumber(bot) + "</td>";
        rs += "<td style='color: #7a6fbe'>" + commaSeparateNumber(total) + "</td>";
        rs += "</tr>";
        return rs;
    }
    ...
    function resulttotalcurrent(moneyuser, moneyagent, moneyagent1, moneyagent2, moneybot, total) {
        ...
        var rs = "";
        rs += "<tr>";
        rs += "<td style='color: #7a6fbe'>" + commaSeparateNumber(moneyuser) + "</td>";
        rs += "<td style='color: #7a6fbe'>" + commaSeparateNumber(moneyagent) + "</td>";
        rs += "<td style='color: #7a6fbe'>" + commaSeparateNumber(moneyagent1) + "</td>";
        rs += "<td style='color: #7a6fbe'>" + commaSeparateNumber(moneyagent2) + "</td>";
        rs += "<td style='color: #7a6fbe'>" + commaSeparateNumber(moneybot) + "</td>";
        rs += "<td style='color: #7a6fbe'>" + commaSeparateNumber(total) + "</total>";
        rs += "</tr>";
        return rs;
    }
            ...
            success: function(res) {
                ...
                if (res.actionGame == null || res.actionGame == "") {
                    ...
                    if (res.actionGame.PokeGo != null) {
                        var stt = 5;
                        result1 += resultSearchTransction(stt, "PokeGo", res.actionGame.PokeGo.moneyWin, res.actionGame.PokeGo.moneyLost, res.actionGame.PokeGo.moneyOther, res.actionGame.PokeGo.fee, res.actionGame.PokeGo.revenuePlayGame, res.actionGame.PokeGo.revenue);
                        $('#logaction').html(result1);
                    }
                    if (res.actionGame.KhoBau != null) {
                        var stt = 6;
                        result1 += resultSearchTransction(stt, "Kho Báu", res.actionGame.KhoBau.moneyWin, res.actionGame.KhoBau.moneyLost, res.actionGame.KhoBau.moneyOther, res.actionGame.KhoBau.fee, res.actionGame.KhoBau.revenuePlayGame, res.actionGame.KhoBau.revenue);
                        $('#logaction').html(result1);
                    }
                    ...
                    if (res.actionGame.NuDiepVien != null) {
                        var stt = 9;
                        result1 += resultSearchTransction(stt, "Nữ Điệp Viên", res.actionGame.NuDiepVien.moneyWin, res.actionGame.NuDiepVien.moneyLost, res.actionGame.NuDiepVien.moneyOther, res.actionGame.NuDiepVien.fee, res.actionGame.NuDiepVien.revenuePlayGame, res.actionGame.NuDiepVien.revenue);
                        $('#logaction').html(result1);
                    }
                    var total1 = 0;
                    var total2 = 0;
                ...
                if (res.actionGameBot == null || res.actionGameBot == "") {
                    ...
                    if (res.actionGameBot.PokeGo != null) {
                        var stt = 5;
                        result3 += resultSearchTransctionbot(stt, "PokeGo", res.actionGameBot.PokeGo.moneyWin, res.actionGameBot.PokeGo.moneyLost, res.actionGameBot.PokeGo.moneyOther, res.actionGameBot.PokeGo.fee, res.actionGameBot.PokeGo.revenuePlayGame, res.actionGameBot.PokeGo.revenue);
                        $('#logactionbot').html(result3);
                    }
                    if (res.actionGameBot.KhoBau != null) {
                        var stt = 6;
                        result3 += resultSearchTransctionbot(stt, "Kho Báu", res.actionGameBot.KhoBau.moneyWin, res.actionGameBot.KhoBau.moneyLost, res.actionGameBot.KhoBau.moneyOther, res.actionGameBot.KhoBau.fee, res.actionGameBot.KhoBau.revenuePlayGame, res.actionGameBot.KhoBau.revenue);
                        $('#logactionbot').html(result3);
                    }
