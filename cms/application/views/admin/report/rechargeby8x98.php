                ...
                <div class="formRow">
                    ...
                    <table>
                        <tr>
                            ...
                            <td><label style="margin-left: 50px;margin-bottom:-2px;width: 100px">Mệnh giá:</label></td>
                            <td class="">
                ...
                <div class="formRow">
                    <table>
                        <tr>
                            ...
                            <td><label style="margin-left: 50px;margin-bottom:-2px;width: 100px">Đầu số:</label></td>
                            <td class="">
