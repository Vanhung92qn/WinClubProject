            ...
            <div class="formRow">
                <table>
                    <tr>
                        ...
                        <td><label style="margin-left: 68px;margin-bottom:-2px;width: 100px">Trạng thái:</label>
                        </td>
                        <td class="">
...
function resultSearchTransction(stt, rid, nickName, target, amount, status, message, code, date, provider, partner,
    type) {
    var rs = "";
    rs += "<tr>";
    rs += "<td>" + stt + "</td>";
            ...
            if (result.transactions == "") {
                ...
                $.each(result.transactions, function(index, value) {
                    result += resultSearchTransction(stt, value.referenceId, value.nickName,
                        value.target, value.amount, value.status, value.message, value
                        .code, value.timeLog, value.provider, value.partner, value.type);
                    stt++;
                });
