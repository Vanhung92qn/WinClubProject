                ...
                <div class="formRow">
                    ...
                    <table>
                        <tr>
                            ...
                            <td class="">
                                <select id="select_provider" name="select_provider" style="margin-left: 20px;margin-bottom:-2px;width: 143px">
                ...
                <div class="formRow">
                    ...
                    <table>
                        <tr>
                            ...
                            <td class="">
                                <select id="select_partner" name="select_partner" style="margin-left: 23px;margin-bottom:-2px;width: 143px">
                            ...
                            <td>
                                <input type="reset" onclick="window.location.href = '<?php echo admin_url('report/cashoutbycard') ?>'; " value="Reset" class="basic" style="margin-left: 20px">
                            </td>
