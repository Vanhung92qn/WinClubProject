                        ...
                        <tr>
                            ...
                            <td class="">
                                <select id="select_provider" name="select_provider" style="margin-left: 0px;margin-bottom:-2px;width: 143px">
                                    ...
                                    <option value="Mobifone" <?php if ($this->input->post('select_provider') == "Mobifone") {
                                                                    echo "selected";
                                                                } ?>>Mobifone
                                    </option>
                                    <option value="Vinaphone" <?php if ($this->input->post('select_provider') == "Vinaphone") {
                                                                    echo "selected";
                                                                } ?>>Vinaphone
                                    </option>
                                    ...
                                    <option value="VietNamMobile" <?php if ($this->input->post('select_provider') == "VietNamMobile") {
                                                                        echo "selected";
                                                                    } ?>>VietNamMobile
                                    </option>
                                </select>
                ...
                <div class="formRow">
                    <table>
                        <tr>
                            ...
                            <td class="">
                                <select id="select_menhgia" name="select_menhgia" style="margin-left: 20px;margin-bottom:-2px;width: 143px">
                                    <option value="">Chọn</option>
                            ...
                            <td class="">
                                <select id="select_table" name="select_table" style="margin-left: 20px;margin-bottom:-2px;width: 143px">
                ...
                <div class="formRow">
                    <table>
                        <tr>
                            ...
                            <td class="">
                                <select id="select_partner" name="select_partner" style="margin-left: 0px;margin-bottom:-2px;width: 143px">
                            ...
                            <td class="">
                                <select id="select_dichvu" name="select_dichvu" style="margin-left: -25px;margin-bottom:-2px;width: 143px">
                            ...
                            <td style="">
                                <input type="submit" id="search_tran" value="Xuất Excel" class="button blueB" name="ok" style="margin-left: 50px">
                            </td>
                        </tr>
                    </table>
                </div>
