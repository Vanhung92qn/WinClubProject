...
<?php else: ?>
    ...
    <tr>
        <td rowspan="28"
            style="vertical-align: middle;color:#7a6fbe;text-align: center;background: #e8e2e2;font-weight: 700; font-size: 20px">
            Tiền vào game
        </td>
    ...
    <tr>
        <td style="color:  #7a6fbe;font-size: 20px;font-weight:700">Tổng tiền vào</td>
        <td style="color: #7a6fbe;font-size: 20px;font-weight:700;text-align: right" ></td>
        <td style="color: #7a6fbe;font-size: 20px;font-weight:700;text-align: right" id="money29"></td>
    </tr>
    <tr>
    ...
    <tr class="moneysystem">
        ...
        <td class="tdmoney" id="cashoutbybank"></td>
        <td class="tdmoney" id="cashoutbybankWin"></td>
    </tr>
    <tr class="moneysystem">
        <td>Rút qua Momo</td>
        <td class="tdmoney" id="cashoutbymomo"></td>
        <td class="tdmoney" id="cashoutbymomoWin"></td>
    </tr>
    <tr>
    ...
    <tr>
        <td style="color: #7a6fbe;font-size: 20px;font-weight:700">Tổng tiền đổi thưởng</td>
        <td style="color: #7a6fbe;font-size: 20px;font-weight:700;text-align: right" id="money40"></td>
        <td style="color: #7a6fbe;font-size: 20px;font-weight:700;text-align: right" id="money41"></td>
    </tr>
    <tr>
        <td colspan="4" style="height: 50px"></td>
    </tr>
    ...
    <tr>
        ...
        <td style="color:#7a6fbe;font-size: 20px;font-weight:700;text-align: right" id="money48"></td>
        <td style="color:#7a6fbe;font-size: 20px;font-weight:700;text-align: right" id="money49"></td>
    </tr>
    <tr>
        <td colspan="4" style="height: 50px"></td>
    </tr>
    ...
    <tr>
        <td style="color: #7a6fbe;font-size: 20px;font-weight:700">Tiền lệch user</td>
        <td style="color: #7a6fbe;font-size: 20px;font-weight:700;text-align: right" id="money52"></td>
        <td style="color: #7a6fbe;font-size: 20px;font-weight:700;text-align: right" id="money53"></td>
    </tr>
    <tr>
        <td colspan="4" style="height: 50px"></td>
    </tr>
    <tr>
        <td></td>
        <td style="color: #7a6fbe;font-size: 20px;font-weight:700">Tỉ lệ đổi thưởng</td>
...
$(document).ready(function () {
    ...
    $.ajax({
        ...
        success: function (res) {
            ...
            $("#resultsearch").html("");
            var total1 = 0;
            var feeCashoutBank = 1;
            var feeCashoutMomo = 1;
            var feeCashoutCard = 1;
            var bill;
            if(res.success){
                if(res.billConfig !== undefined){
                    bill = JSON.parse(res.billConfig);
                    feeCashoutBank = bill.ratio_cashout_bank;
                    feeCashoutMomo = bill.ratio_cashout_momo;
                    feeCashoutCard = bill.ratio_mua_the;
            ...
            if ($.isEmptyObject(res.vinInUser)) {
                ...
                if (res.vinInUser.RechargeByBank != null || res.vinInUser.RechargeByBank != null) {
                    $("#money3").html(commaSeparateNumber(res.vinInUser.RechargeByBank ));
                    $("#money4").html(commaSeparateNumber(res.vinInUser.RechargeByBank));
                    total1 += res.vinInUser.RechargeByBank;
                } else {
                    $("#money3").html(0);
                    $("#money4").html(0);
                }
                if (res.vinInUser.RechargeByMomo != null || res.vinInUser.RechargeByMomo != null) {
                    $("#money5").html(commaSeparateNumber(res.vinInUser.RechargeByMomo));
                    $("#money6").html(commaSeparateNumber(res.vinInUser.RechargeByMomo));
                    total1 += res.vinInUser.RechargeByMomo;
                } else {
                    $("#money5").html(0);
                    $("#money6").html(0);
                }
                ...
                if  ( res.vinInUser.TopupVTCPay !== undefined && res.vinInUser.TopupVTCPay != null && res.vinInUser.TopupVTCPay != "") {
            ...
            if ($.isEmptyObject(res.vinOutUser)) {
                ...
                $("#money32").html(0);
                $("#money33").html(0);
                $("#cashoutbybank").html(0);
                $("#cashoutbybankWin").html(0);
                $("#cashoutbymomo").html(0);
                $("#cashoutbymomoWin").html(0);
            } else {
                if (res.vinOutUser.CashOutByCard != null || res.vinOutUser.CashOutByCard != null) {
                    $("#money30").html(commaSeparateNumber(Math.round(res.vinOutUser.CashOutByCard/feeCashoutCard)));
                    $("#money31").html(commaSeparateNumber(res.vinOutUser.CashOutByCard));
                    total2 += Math.round(res.vinOutUser.CashOutByCard/CashOutByCard);
                } else {
                    $("#money30").html(0);
                    $("#money31").html(0);
                }
                if (res.vinOutUser.CashOutByBank != null || res.vinOutUser.CashOutByBank != null) {
                    $("#cashoutbybank").html(commaSeparateNumber(Math.round(res.vinOutUser.CashOutByBank/feeCashoutBank)));
                    $("#cashoutbybankWin").html(commaSeparateNumber(res.vinOutUser.CashOutByBank));
                    total2 += Math.round(Math.round(res.vinOutUser.CashOutByBank/feeCashoutBank));
                } else {
                    $("#cashoutbybank").html(0);
                    $("#cashoutbybankWin").html(0);
                }
                if (res.vinOutUser.CashOutByMomo != null || res.vinOutUser.CashOutByMomo != null) {
                    $("#cashoutbymomo").html(commaSeparateNumber(Math.round(res.vinOutUser.CashOutByMomo/feeCashoutMomo)));
                    $("#cashoutbymomoWin").html(commaSeparateNumber(res.vinOutUser.CashOutByMomo));
                    total2 += Math.round(Math.round(res.vinOutUser.CashOutByMomo/feeCashoutMomo));
                } else {
                    $("#cashoutbymomo").html(0);
                    $("#cashoutbymomoWin").html(0);
                }
            ...
            $("#money35").html(commaSeparateNumber(total2));
            ...
            // $("#money41").html(commaSeparateNumber(Math.round(res.totalOutAgent*0.83)+total2));
            var total3 = 0;
            var total4 = 0;
            if (res.taiXiu) {
            ...
            if (res.actionGame) {
                ...
                if (res.actionGame.PokeGo != null) {
                    total3 += res.actionGame.PokeGo.revenue;
                }
