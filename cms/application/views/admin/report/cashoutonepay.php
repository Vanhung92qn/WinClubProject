                        ...
                        <tr>
                            ...
                            <td class="">
                                <select id="select_bank" name="select_bank"
                                    ...
                                    <option value="">Chọn</option>
                                    <option value="MSB"
                                        <?php if($this->input->post('select_bank') == "MSB" ){echo "selected";} ?>>Maritime
                                    </option>
                                    <option value="BIDV"
                                        <?php if($this->input->post('select_bank') == "BIDV" ){echo "selected";} ?>>BIDV
                                    </option>
                                    <option value="VietinBank"
                                        <?php if($this->input->post('select_bank') == "VietinBank" ){echo "selected";} ?>>
                                        VietinBank</option>
                                    <option value="VietcomBank"
                                        <?php if($this->input->post('select_bank') == "VietcomBank" ){echo "selected";} ?>>
                                        VietcomBank</option>
                                </select>
                            </td>
                        </tr>
...
<script>
    ...
    function resultSearchTransction(stt, rid, nickName, bank, accnh, nametknh, moneytran, status, message, strTime, userApprove) {
        var rs = "";
        rs += "<tr>";
        rs += "<td>" + stt + "</td>";
        rs += "<td>" + rid + "</td>";
                ...
                if (result.ListTrans == "") {
                    ...
                    $.each(result.ListTrans, function(index, value) {
                        result += resultSearchTransction(
                            stt, value.Id, value.Username, value.BankName, value.BankAccountNumber, value.BankAccountName, value.Amount, value.Status, "", value.CreatedAt, value.UserProve
                        );
                        stt++;
                    });
