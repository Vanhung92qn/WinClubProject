...
$(document).ready(function () {
    ...
    $.ajax({
        ...
        success: function (result1) {
            ...
            result += "</tr>";
            result += "<tr>";
            result += "<td rowspan='" + mm + "' style='vertical-align: middle;color:#7a6fbe;text-align: center;background: #e8e2e2;font-weight: 700; font-size: 20px'>" + "Vietnam Mobile" + "</td>";
            result += "</tr>";
            ...
            result += "</tr>";
            result += "<tr>";
            result += "<td rowspan='" + nn + "' style='vertical-align: middle;color:#7a6fbe;text-align: center;background: #e8e2e2;font-weight: 700; font-size: 20px'>" + "Gate" + "</td>";
            result += "</tr>";
            ...
            result += "<tr>";
            result += "<td rowspan='" + oo + "' style='vertical-align: middle;color:#7a6fbe;text-align: center;background: #e8e2e2;font-weight: 700; font-size: 20px'>" + "Zing" + "</td>";
            result += "</tr>";
