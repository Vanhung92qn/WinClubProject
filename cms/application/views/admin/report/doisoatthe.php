...
$(document).ready(function () {
    ...
    $.ajax({
        ...
        success: function (result1) {
            ...
            result += "</tr>";
            result += "<tr>";
            result += "<td rowspan='" + ii + "' style='vertical-align: middle;color:#7a6fbe;text-align: center;background: #e8e2e2;font-weight: 700; font-size: 20px'>" + "Viettel" + "</td>";
            result += "</tr>";
            ...
            result += "</tr>";
            result += "<tr>";
            result += "<td rowspan='" + jj + "' style='vertical-align: middle;color:#7a6fbe;text-align: center;background: #e8e2e2;font-weight: 700; font-size: 20px'>" + "Vinaphone" + "</td>";
            result += "</tr>";
            ...
            result += "</tr>";
            result += "<tr>";
            result += "<td rowspan='" + kk + "' style='vertical-align: middle;color:#7a6fbe;text-align: center;background: #e8e2e2;font-weight: 700; font-size: 20px'>" + "Mobifone" + "</td>";
            result += "</tr>";
            ...
            result += "</tr>";
            result += "<tr>";
            result += "<td rowspan='" + mm + "' style='vertical-align: middle;color:#7a6fbe;text-align: center;background: #e8e2e2;font-weight: 700; font-size: 20px'>" + "Gate" + "</td>";
            result += "</tr>";
            ...
            result += "</tr>";
            result += "<tr>";
            result += "<td rowspan='" + nn + "' style='vertical-align: middle;color:#7a6fbe;text-align: center;background: #e8e2e2;font-weight: 700; font-size: 20px'>" + "MegaCard ko VAT" + "</td>";
            result += "</tr>";
            ...
            result += "</tr>";
            result += "<tr>";
            result += "<td rowspan='" + oo + "' style='vertical-align: middle;color:#7a6fbe;text-align: center;background: #e8e2e2;font-weight: 700; font-size: 20px'>" + "MegaCard có VAT" + "</td>";
            result += "</tr>";
            ...
            result += "<tr>";
            result += "<td rowspan='" + pp + "' style='vertical-align: middle;color:#7a6fbe;text-align: center;background: #e8e2e2;font-weight: 700; font-size: 20px'>" + "Vcoin" + "</td>";
            result += "</tr>";
