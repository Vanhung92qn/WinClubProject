...
<div class="wrapper">
    ...
    <div class="widget">
            ...
            <div class="formRow">
                ...
                <table>
                    <tr>
                        ...
                        <td><label style="margin-left: 29px;margin-bottom:-2px;width: 100px">Số điện thoại:</label></td>
                        <td><input type="text" style="margin-left: 20px;margin-bottom:-2px;width: 150px" id="txtmobile"
                                value="<?php echo $this->input->post('txtmobile') ?>" name="txtmobile"></td>
        ...
        <div class="formRow">
            <h5>Tổng tin nhắn nhận về thành công:<span style="color: #7a6fbe" id="summesrec"></span></h5>
            <h5>Tổng tin nhắn gửi đi thành công:<span style="color: #7a6fbe" id="summessend"></span></h5>
        </div>
        ...
        success: function(result) {
            ...
            if (result.records == "") {
                ...
                $.each(result.records, function(index, value) {
                    result += resultSearchTransction(stt, value.requestId, value.mobile,
                        value.commandCode, value.messageMO, value.responseMO, value
                        .messageMT, value.responseMT, value.transTime);
                    stt++;
                });
