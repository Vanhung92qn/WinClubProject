...
<?php else : ?>
    <div class="wrapper">
        ...
        <div class="widget">
                ...
                <div class="formRow">
                    ...
                    <table>
                        <tr>
                            ...
                            <td><input type="text" style="margin-left: 20px;margin-bottom:-2px;width: 150px" id="filter_iname" value="<?php echo $this->input->post('name') ?>" name="name">
                            </td>
                            <td><label style="margin-left: 50px;margin-bottom:-2px;width: 100px">Loại thẻ:</label></td>
                            <td class="">
                                <select id="select_provider" name="select_provider" style="margin-left: 0px;margin-bottom:-2px;width: 143px">
                                    <option value="">Chọn</option>
                                    <option value="VT" <?php if ($this->input->post('select_provider') == "VT") {
                                                                echo "selected";
                                                            } ?>>Viettel
                                    </option>
                                    <option value="MB" <?php if ($this->input->post('select_provider') == "MB") {
                                                                    echo "selected";
                                                                } ?>>Mobifone
                                    </option>
                                    <option value="VN" <?php if ($this->input->post('select_provider') == "VN") {
                                                                    echo "selected";
                                                                } ?>>Vinaphone
                                    </option>
                                </select>
                ...
                <div class="formRow">
                    <table>
                        <tr>
                            ...
                            <td><input type="text" style="margin-left: 20px;margin-bottom:-2px;width: 150px" id="txtmathe" value="<?php echo $this->input->post('txtmathe') ?>" name="txtmathe">
                            </td>
                            <td><label style="margin-left: 50px;margin-bottom:-2px;width: 100px">Mã serial:</label></td>
                            <td><input type="text" style="margin-left: 20px;margin-bottom:-2px;width: 150px" id="txtserial" value="<?php echo $this->input->post('txtserial') ?>" name="txtserial"></td>
                        </tr>
                    </table>
                </div>
                <div class="formRow">
                    <table>
                        <tr>
                            ...
                            <td class="">
                                <select id="select_status" name="select_status" style="margin-left: 20px;margin-bottom:-2px;width: 143px">
                                    <option value="">Chọn</option>
                                    ...
                                    <option value="100" <?php if ($this->input->post('select_status') == "0") {
                                                            echo "selected";
                                                        } ?>>Thành công
                                    </option>
                                    <!-- <option value="1" <?php if ($this->input->post('select_status') == "1") {
                            ...
                            <td>
                                <input type="reset" onclick="window.location.href = '<?php echo admin_url('report/rechargebycard') ?>'; " value="Reset" class="basic" style="margin-left: 20px">
                            </td>
                        </tr>
                    </table>
                </div>
            ...
            <table class="table table-bordered table-striped" id="checkAll" style="table-layout: fixed;word-wrap: break-word;">
                <thead>
                    <tr>
                        <td>Viettel</td>
                        <td>Vinaphone</td>
            ...
            <!-- <input type="button" id="updateall" class="button blueB" style="float: right;margin: 20px" value="Cập nhật tất cả"> -->
...
<div class="modal fade" id="bsModal4" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            <div class="modal-header">
            </div>
...
<div class="modal fade" id="bsModal5" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            <div class="modal-header">
            </div>
...
<div class="modal fade" id="bsModal6" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            <div class="modal-header">
            </div>
...
<div class="modal fade" id="bsModal7" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            <div class="modal-header">
            </div>
...
<div class="modal fade" id="bsModal8" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            <div class="modal-header">
            </div>
...
<div class="modal fade" id="bsModal9" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            <div class="modal-header">
            </div>
...
<div class="modal fade" id="bsModal10" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            <div class="modal-header">
            </div>
...
<div class="modal fade" id="bsModal11" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            <div class="modal-header">
            </div>
...
<script>
    ...
    function resultSearchTransction(stt, rid, nickName, provider, partner, serial, pin, amount, status, message, code, date) {
        ...
        rs += `<td>${getMessageByCode(status)}</td>`;
        rs += "<td>" + message + "</td>";
        // rs += "<td>" + code + "</td>";
        rs += "<td>" + date + "</td>";
        // if (code == 30) {
    ...
    function resultnhamang(viettel, vina, mobi) {
        var rs = "";
        rs += "<tr>";
    ...
    function searchRecharge(currentPage) {
        var result = "";
        var result1 = "";
        var result2 = "";
        var oldpage = 0;
        ...
        $.ajax({
            ...
            success: function(result) {
                ...
                if (result.transactions == "") {
                    ...
                    $("#resultsearch").html("");
                    var totalPage = Math.ceil(result.totalRecord / 50);
                    // update later
                    /*
                    ...
                    */
                    ...
                    var stt = 1;
                    var totalmoney = 0;
                    var totalrecord = commaSeparateNumber(result?.transactions?.length);
                    $.each(result.transactions, function(index, value) {
                        if(value.provider == "VT") {
                            total1 += value.amount
                        } else if(value.provider == "VN") {
                            total2 += value.amount
                        } else  if(value.provider == "MB") {
                            total3 += value.amount
                        }
                    ...
                    result1 += resultnhamang(total1, total2, total3);
                    $('#logaction1').html(result1);
                    $('#summoney').html(commaSeparateNumber(totalmoney));
