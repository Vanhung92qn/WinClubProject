        ...
        success: function(res) {
            ...
            if (res.trans == "") {
                ...
                $.each(res.trans, function(index, value) {
                    result += resultSearchTransction(stt, value.transId, value.nickName,
                        value.price, value.responseCode, value.description, value
                        .timeRequest, value.timeResponse);
                    stt++;
                });
                    ...
                    onPageClick: function(event, page) {
                        ...
                        if (oldpage > 0) {
                            ...
                            $.ajax({
                                ...
                                data: {
                                    nickname: $("#filter_iname").val(),
                                    toDate: $("#toDate").val().replace(
                                        /[-:  +]/g, ''),
                                    fromDate: $("#fromDate").val().replace(
                                        /[-:  +]/g, ''),
                                    pages: page,
                                    tranid: $("#magiaodich").val(),
                                    price: $("#select_price").val(),
