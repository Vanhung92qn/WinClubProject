...
<?php else : ?>
    <div class="wrapper">
        ...
        <div class="widget">
                ...
                <div class="formRow">
                    ...
                    <table>
                        <tr>
                            ...
                            <td><input type="text" style="margin-left: 20px;margin-bottom:-2px;width: 150px" id="txtmobile" value="<?php echo $this->input->post('txtmobile') ?>" name="txtmobile"></td>
                ...
                <div class="formRow">
                    ...
                    <table>
                        <tr>
                            ...
                            <td>
                                <input type="reset" onclick="window.location.href = '<?php echo admin_url('report/logbrandname') ?>'; " value="Reset" class="basic" style="margin-left: 20px">
                            </td>
                        </tr>
                    </table>
                </div>
            ...
            <div class="formRow">
                <h5>Tổng số tin nhắn gửi đi:<span style="color: #7a6fbe" id="summessend"></span></h5>
                <h5>Tổng só tin nhắn thành công:<span style="color: #7a6fbe" id="summessuc"></span></h5>
            </div>
