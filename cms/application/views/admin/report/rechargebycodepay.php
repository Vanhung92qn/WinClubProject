<title>Nạp Tiền Qua Ngân Hàng</title>
<div class="titleArea">
    <div class="wrapper">
        <div class="pageTitle">
...
<div class="wrapper">
    ...
    <div class="widget" style="background: #82d1ff; border-radius: 15px;">
        ...
        <div class="title">
            <h6 style="color: #001f0f;">Lịch sử nạp tiền qua ngân hàng</h6>
        </div>
        <form class="list_filter form" method="post">
            <div class="formRow">
                <table>
                    <tr>
                        <td>
                        ...
                        <td class="item">
                            <div class="input-group date" id="datetimepicker1">
                                <input type="text" id="fromDate" name="toDate" value="<?php echo $start_time ?>">
                        ...
                        <td class="item">
                            ...
                            <div class="input-group date" id="datetimepicker2">
                                <input type="text" id="toDate" name="fromDate" value="<?php echo $end_time ?>">
                                <span class="input-group-addon">
                                    <span class="glyphicon glyphicon-calendar"></span>
                                </span>
                            </div>
            ...
            <div class="formRow">
                ...
                <table>
                    <tr>
                        ...
                        <td><select id="select_status" name="select_status" style="margin-left: 0px;margin-bottom:-2px;width: 143px">
                                <option value="">Chọn</option>
                                <option value="2" <?php if ($this->input->post('select_status') == "100") {
                                                        echo "selected";
                                                    } ?>>Thành công
                                </option>
                                ...
                                <option value="100" <?php if ($this->input->post('select_status') == "2") {
                                                        echo "selected";
                                                    } ?>>Từ chối
                                </option>
                            </select>
                        </td>
                        <td style="display: none;"><label style="margin-left: 50px;margin-bottom:-2px;width: 100px">Số bản ghi:</label></td>
                        <td style="display: none;"><input type="hidden" id="max_item" name="max_item" style="margin-left: 0px;margin-bottom:-2px;width: 143px" value="50" />
                        </td>
                    </tr>
            ...
            <div class="formRow">
                <table>
                    <tr>
                        ...
                        <td><input type="text" style="margin-left: 20px;margin-bottom:-2px;width: 150px" id="txtip" value="<?php echo $this->input->post('txtip') ?>" name="txtip"></td> -->
                        <td><label style="margin-left: 50px;margin-bottom:-2px;width: 100px">Ngân hàng:</label></td>
                        <td><select id="select_bank" name="select_bank" style="margin-left: 0px;margin-bottom:-2px;width: 143px">
                                <option value="">Chọn</option>
                                ...
                                <option value="VIB" <?php if ($this->input->post('select_bank') == "VIB") {
                                                        echo "selected";
                                                    } ?>>VIB
                                </option>
                        ...
                        <td><label style="margin-left: 30px;margin-bottom:-2px;width: 100px">Mã Codepay:</label></td>
                        <td><input type="text" style="margin-left: 20px;margin-bottom:-2px;width: 150px" id="txtcodepay" value="<?php echo $this->input->post('txtcodepay') ?>" name="txtcodepay"></td>
                    </tr>
                </table>
            </div>
            <div class="formRow">
                <table>
                    <tr>
                        ...
                        <td><input type="text" style="margin-left: 20px;margin-bottom:-2px;width: 150px" id="txtvinplay" value="<?php echo $this->input->post('txtvinplay') ?>" name="txtvinplay"></td>
                        ...
                        <td>
                            <input type="reset" onclick="window.location.href = '<?php echo admin_url('report/rechargebycodepay') ?>'; " value="Reset" class="basic" style="margin-left: 20px">
                        </td>
...
<script>
    ...
    function resultSearchTransction(stt, tid, nickname, money, bank, ip, status, description, time, updatetime, userApprove, sender) {
        ...
        if (status == 1 && sender == 'CodePay') {
            rs += "<td style='color: #0008ff;font-weight: bold;'><input class='form-control keyupCheck' name='' id=" + tid + "_money" + "></td>";
        } else {
    ...
    function reject(tid) {
        $.ajax({
            type: "POST",
            url: "<?php echo admin_url('report/updatedepositcodepaymanual') ?>",
            data: {
                transId: tid,
                type: 1,
                money: 0
    ...
    function approveCodePay(tid) {
        ...
        if (!moneyCodePay || moneyCodePay == 0) {
            alert("Số tiền không được bằng 0");
            return;
        }
        $.ajax({
            type: "POST",
        ...
        $.ajax({
            ...
            success: function(result) {
                ...
                if (result.ListTrans == "") {
                    ...
                    // Check if pagination already initialized
                    if ($('#pagination-demo').data('twbsPagination')) {
