            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-body">
                        ...
                        <form action="<?php echo base_url('giftcodevh/giftcodevhuse') ?>" method="post">
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-sm-1"><input type="reset" value="Reset" name="submit"
                                                                 ...
                                                                 onclick="window.location.href = '<?php echo base_url('giftcodevh/giftcodevhuse') ?>'; ">
                                    </div>
...
$(document).ready(function () {
    ...
    if ($("#money").val() == 1) {
        $.ajax({
            type: "POST",
            url: "<?php echo base_url('giftcodevh/giftcodevhuseajax') ?>",
            data: {
