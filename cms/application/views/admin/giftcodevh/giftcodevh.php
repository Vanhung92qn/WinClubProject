            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-body">
                        ...
                        <form action="<?php echo base_url('giftcodevh/giftcodevh') ?>" method="post">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-2">
                                        <div class="input-group date" id="datetimepicker1">
                                            <input type="text" class="form-control" id="fromDate" name="fromDate" value="<?php echo $this->input->post("fromDate") ?>">
                                    ...
                                    <div class="col-sm-2">
                                        <div class="input-group date" id="datetimepicker2">
                                            <input type="text" class="form-control" id="toDate" name="toDate" value="<?php echo $this->input->post("toDate") ?>">
                                            <span class="input-group-addon">
                                                <span class="glyphicon glyphicon-calendar"></span>
                                            </span>
                                        </div>
                                    </div>
                                    <div class="col-sm-1"><input type="submit" value="Tìm kiếm" name="submit" class="btn btn-primary pull-right" id="search_tran"></div>
                                    <div class="col-sm-1"><input type="reset" value="Reset" name="submit" class="btn btn-primary pull-left" id="reset" onclick="window.location.href = '<?php echo base_url('giftcode/giftcodemkt') ?>'; "></div>
                                    <div class="col-sm-1"><input type="button" value="Xuất Exel" name="submit" class="btn btn-primary pull-left" id="exportexel"></div>
                                </div>
                            </div>
                        </form>
                        <div class="col-sm-12">
...
<script>
    ...
    $(document).ready(function() {
        ...
        if ($("#money").val() == 1) {
            $.ajax({
                type: "POST",
                url: "<?php echo base_url('giftcodevh/giftcodevhajax') ?>",
                data: {
                    roomvin: $("#roomvin").val(),
