    ...
    <section class="content">
        <div class="row">
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-body">
                        <form action="<?php echo base_url('logaction') ?>" method="post" style="padding:15px 15px 5px;">
                            <div class="form-group">
                                <div class="row">

                                    <label class="col-xl-2 col-lg-1 control-label">Tài khoản admin</label>

                                    <div class="col-sm-2">
                                        <input type="text" class="form-control" name="name"
                                            value="<?php echo $this->input->post('name')?>">
                                    </div>
                                    <label class="col-xl-2 col-lg-1 control-label">Hành động admin</label>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <label class="col-xl-2 col-lg-1 control-label">Từ ngày:</label>
                                    ...
                                    <label class="col-xl-2 col-lg-1 control-label">Đến ngày:</label>
                                    ...
                                    <div class="col-sm-1"><input type="reset" value="Reset" name="submit"
                                            ...
                                            onclick="window.location.href = '<?php echo base_url('logaction') ?>'; "></div>
                                </div>
                            </div>
                        </form>
                        <div class="col-sm-12">
