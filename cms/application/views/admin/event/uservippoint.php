...
<?php else : ?>
    <div class="wrapper">
        ...
        <script src="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-datetimepicker/4.15.35/js/bootstrap-datetimepicker.min.js">
        </script>
        <div class="widget">
                ...
                <div class="formRow">
                    <table>
                        <tr>
                            ...
                            <td><label style="margin-left: 50px;margin-bottom:-2px;width: 100px">Sắp xếp:</label></td>
                    ...
                    <table>
                        <tr>
                            ...
                            <td class="lstcheckbox">
                                ...
                                <input type="checkbox" value="3" name="chklist" id="filed_2"><span style="padding-left: 10px;">VP Được cộng</span>
                                <input type="checkbox" value="4" name="chklist" id="filed_3"><span style="padding-left: 10px;">Số lần cộng</span>
                                <input type="checkbox" value="5" name="chklist" id="filed_4"><span style="padding-left: 10px;">VP bị trừ</span>
                                <input type="checkbox" value="6" name="chklist" id="filed_5"><span style="padding-left: 10px;">Số lần trừ</span>
                                <input type="checkbox" value="7" name="chklist" id="filed_6"><span style="padding-left: 10px;">Cứ điểm</span>
                ...
                <div class="formRow">
                    ...
                    <table>
                        <tr>
                            ...
                            <td>
                                <input type="reset" onclick="window.location.href = '<?php echo admin_url('event/uservippoint') ?>'; " value="Reset" class="basic" style="margin-left: 20px">
                            </td>
            ...
            <div class="formRow">
                <div class="row">
                    ...
                    <div class="col-sm-2">
                        <h5>Tổng số bản ghi:<span style="color: #7a6fbe" id="sumrecord"></span></h5>
                    </div>
                </div>
            </div>
...
<script>
    ...
    function resultSearchTransction(stt, nickname, vpReal, vpEvent, vpAdd, numAdd, vpSub, numSub, place, placeMax, isbot,
        date) {
        var rs = "";
        rs += "<tr>";
        rs += "<td>" + stt + "</td>";
            ...
            success: function(result) {
                ...
                if (result.transactions == "") {
                    ...
                    $.each(result.transactions, function(index, value) {
                        result += resultSearchTransction(stt, value.nickName, value.vp_real,
                            value.vp_event, value.vp_add, value.num_add, value.vp_sub, value
                            .num_sub, value.place, value.placemax, value.is_bot, value
                            .updateTime);
                        stt++;
