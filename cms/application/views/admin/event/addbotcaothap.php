...
<?php else: ?>
    ...
    <div class="formRow">
        <div class="row">
            ...
            <div class="col-sm-4"><h3 style="color: #7a6fbe">* Chú ý : Các là bài không được trùng nhau</h3> </div>
        </div>
    </div>
        ...
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p style="color: #7a6fbe">Bạn thêm bot cao thấp thành công</p>
                </div>
