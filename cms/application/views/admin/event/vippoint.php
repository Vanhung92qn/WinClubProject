                ...
                <div class="formRow">
                    <table>
                        <tr>
                            ...
                            <td><input type="text" style="margin-left: 20px;margin-bottom:-2px;width: 150px" id="txtvalue" value="<?php echo $this->input->post('txtvalue') ?>" name="txtvalue">
                            </td>
                            <td><label style="margin-left: 50px;margin-bottom:-2px;width: 100px">Type:</label></td>
                            <td><select id="txttype" name="txttype" style="margin-bottom:-2px;width: 160px">
                                    ...
                                    <option value="1" <?php if ($this->input->post('txttype') == "1") {
                                                            echo "selected";
                                                        } ?>>Cộng vippoint event</option>
                                    <option value="2" <?php if ($this->input->post('txttype') == "2") {
                                                            echo "selected";
                                                        } ?>>Trừ vippoint event</option>
                ...
                <div class="formRow">
                    ...
                    <table>
                        <tr>
                            ...
                            <td>
                                <input type="reset" onclick="window.location.href = '<?php echo admin_url('event/vippoint') ?>'; " value="Reset" class="basic" style="margin-left: 20px">
                            </td>
