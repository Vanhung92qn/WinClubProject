<title>Lịch Sử Chơi Tài Xỉu</title>
                ...
                <div class="formRow">
                    <table>
                        <tr>
                            ...
                            <td>
                                <input type="reset" onclick="window.location.href = '<?php echo admin_url('logminigame') ?>'; " value="Reset" class="basic" style="margin-left: 20px">
                            </td>
                        </tr>
                    </table>
                </div>
...
<script>
    ...
    function resultSearchtaixiu(referenceId, totalxiu, totaltai, numxiu, numtai, dice1, dice2, dice3, result, totalrefundtai, totalrefundxiu, money, datetime) {
        var rs = "";
        rs += "<tr>";
        rs += "<td><a style='color: #7a6fbe' href='logminigame/detailphientaixiu/" + referenceId + "'>" + referenceId + "</a></td>";
