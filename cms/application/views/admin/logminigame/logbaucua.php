                ...
                <div class="formRow">
                    <table>
                        <tr>
                            ...
                            <td><select id="menhgiaxu" name="menhgiaxu" style="margin-left: 0px;margin-bottom:-2px;width: 150px;">
                ...
                <div class="formRow">
                    <table>
                        <tr>
                            ...
                            <td>
                                <input type="reset" onclick="window.location.href = '<?php echo admin_url('logminigame/logbaucua') ?>'; " value="Reset" class="basic" style="margin-left: 20px">
                            </td>
...
<script>
    ...
    function resultlogbaucua(referid, nickname, room, dice, bet_bau, bet_cua, bet_tom, bet_ca, bet_ga, bet_huou, prize_bau, prize_cua, prize_tom, prize_ca, prize_ga, prize_huou, money_type, time_log) {
        var rs = "";
        rs += "<tr>";
        rs += "<td><a style='color: #7a6fbe' href='detailbaucua/" + referid + "'>" + referid + "</a>" + "</td>";
        rs += "<td>" + nickname + "</td>";
