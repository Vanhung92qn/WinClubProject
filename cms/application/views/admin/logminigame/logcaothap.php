<title>Lịch Sử Phiên Cao Thấp</title>
                ...
                <div class="formRow">
                    <table>
                        <tr>
                            ...
                            <td><select id="menhgiavin" name="menhgiavin" style="margin-left: 0px;margin-bottom:-2px;width: 150px;">
                                    ...
                                    <option value="50000" <?php if ($this->input->post('menhgiavin') == "50000") {
                                                                echo "selected";
                                                            } ?>>50K Vin</option>
                                    <option value="100000" <?php if ($this->input->post('menhgiavin') == "100000") {
                                                                echo "selected";
                                                            } ?>>100K Vin</option>
                                    <option value="500000" <?php if ($this->input->post('menhgiavin') == "500000") {
                                                                echo "selected";
                                                            } ?>>500K Vin</option>
                                </select></td>
                            <td><label id="labelxu" style="margin-left: 65px;margin-bottom:-2px;width: 80px;">Phòng xu:</label></td>
                            <td><select id="menhgiaxu" name="menhgiaxu" style="margin-left: 15px;margin-bottom:-2px;width: 150px;">
                                    ...
                                    <option value="500000" <?php if ($this->input->post('menhgiaxu') == "500000") {
                                                                echo "selected";
                                                            } ?>>500K Xu</option>
                                    <option value="1000000" <?php if ($this->input->post('menhgiaxu') == "1000000") {
                                                                echo "selected";
                                                            } ?>>1M Xu</option>
                                    <option value="5000000" <?php if ($this->input->post('menhgiaxu') == "5000000") {
                                                                echo "selected";
                                                            } ?>>5M Xu</option>
                ...
                <div class="formRow">
                    <table>
                        <tr>
                            ...
                            <td class="">
                                <select id="money" name="money" style="margin-bottom:-2px;width: 150px">
                            ...
                            <td>
                                <input type="reset" onclick="window.location.href = '<?php echo admin_url('logminigame/logcaothap') ?>'; " value="Reset" class="basic" style="margin-left: 20px">
                            </td>
                        </tr>
                    </table>
                </div>
