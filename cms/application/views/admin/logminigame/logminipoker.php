<title>Lịch Sử Phiên Mini Poker</title>
                ...
                <div class="formRow">
                    <table>
                        <tr>
                            ...
                            <td class="">
                                <select id="money" name="money" style="margin-bottom:-2px;width: 143px">
                            ...
                            <td>
                                <input type="reset" onclick="window.location.href = '<?php echo admin_url('logminigame/logminipoker') ?>'; " value="Reset" class="basic" style="margin-left: 20px">
                            </td>
                        </tr>
                    </table>
                </div>
