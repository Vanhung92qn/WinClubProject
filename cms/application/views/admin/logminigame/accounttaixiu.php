                ...
                <div class="formRow">
                    <table>
                        <tr>
                            ...
                            <td>
                                <label for="param_name" style="width: 100px;margin-bottom:-3px;margin-left: 23px;" class="formLeft">Phiên: </label>
                            </td>
                            <td><input type="text" style="margin-left: 27px;margin-bottom:-2px;width: 150px" id="phientx" value="<?php echo $this->input->post('phientx') ?>" name="phientx"></td>
                ...
                <div class="formRow">
                    <table>
                        <tr>
                            ...
                            <td class="">
                                <select id="money_type" name="money" style="margin-left: 0px;margin-bottom:-2px;width: 143px">
                            ...
                            <td>
                                <label for="param_name" style="width: 100px;margin-bottom:-3px;margin-left: 64px;" class="formLeft">Cửa đặt: </label>
                            </td>
                            <td class="item"><select id="cuadatid" name="cuadatid" style="margin-left: 5px;margin-bottom:-2px;width: 150px">
                            ...
                            <td>
                                <input type="reset" onclick="window.location.href = '<?php echo admin_url('logminigame/accounttaixiu') ?>'; " value="Reset" class="basic" style="margin-left: 20px">
                            </td>
                        </tr>
                    </table>
                </div>
...
<script>
    ...
    function resultSearchtaixiu(referenceId, user_name, bet_value, bet_side, total_prize, total_refund, total_exchange, time_log, money_type) {
        var rs = "";
        rs += "<tr>";
        rs += "<td><a style='color: #7a6fbe' href='detailphientaixiu/" + referenceId + "'>" + referenceId + "</a></td>";
        rs += "<td>" + user_name + "</td>";
