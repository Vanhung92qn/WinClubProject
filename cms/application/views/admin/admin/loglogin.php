...
<?php else : ?>
    ...
    <div class="wrapper">
        ...
        <div class="widget">
            <?php if (empty($list)) : ?>
                <h4 id="resultsearch" style="color: #e72929;margin-left: 10px"><?php echo "Không tìm thấy kết quả"; ?></h4>
            <?php endif; ?>
            <div class="title">
                ...
                <div class="formRow">
                    <table>
                        <tr>
                            ...
                            <td><input type="text" style="margin-left: 20px;margin-bottom:-2px;width: 150px" id="txtusername" value="<?php echo $this->input->post('username') ?>" name="username">
                            </td>
                            <td>
                                <label for="param_name" style="width: 100px;margin-bottom:-3px;margin-left: 43px;" class="formLeft">Nickname: </label>
                            </td>
                            <td><input type="text" style="margin-left: 27px;margin-bottom:-2px;width: 150px" id="txtnickname" value="<?php echo $this->input->post('nickname') ?>" name="nickname"></td>
                ...
                <div class="formRow">
                    <table>
                        <tr>
                            ...
                            <td><input type="text" style="margin-left: 20px;margin-bottom:-2px;width: 150px" id="txtip" value="<?php echo $this->input->post('txtip') ?>" name="txtip">
                            </td>
                            <td><label style="margin-left: 50px;margin-bottom:-2px;width: 100px">Trạng thái:</label></td>
                            <td class="">
                                <select id="ststatus" name="ststatus" style="margin-left: 0px;margin-bottom:-2px;width: 143px">
