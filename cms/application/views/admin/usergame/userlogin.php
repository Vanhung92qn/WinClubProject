<title>Lịch Sử Tài Khoản Đăng Nhập</title>
    ...
    <div class="wrapper">
        ...
        <div class="widget">
            ...
            <div class="title">
                ...
                <h6 style="float: right">Tổng số:<span style="color:#7a6fbe" id="numuser"></span></h6>
            </div>
                ...
                <div class="formRow">
                    ...
                    <table>
                        <tr>
                            ...
                            <td class="">
                                <input type="text" style="margin-left: 20px;margin-bottom:-2px;width: 150px" id="iplogin" value="<?php echo $this->input->post('iplogin') ?>" name="iplogin">
                            </td>
                            <td><label style="margin-left: 50px;margin-bottom:-2px;width: 100px">Trạng thái:</label></td>
                            <td class="">
                                <select id="status" name="timkiemtheo" style="margin-left: 5px;margin-bottom:-2px;width: 150px">
                ...
                <div class="formRow">
                    <table>
                        <tr>
                            ...
                            <td>
                                <input type="reset" onclick="window.location.href = '<?php echo admin_url('usergame/userlogin') ?>'; " value="Reset" class="basic" style="margin-left: 20px">
                            </td>
                        </tr>
                    </table>
                </div>
...
<script>
    ...
    function resultSearchTransction(stt, username, nickname, ip, agent, type, security, numbergc, date) {
        var rs = "";
        rs += "<tr>";
        rs += "<td>" + stt + "</td>";
        rs += "<td>" + username + "</td>";
            ...
            success: function(result) {
                ...
                if (result.transactions == "") {
                    ...
                    $.each(result.transactions, function(index, value) {
                        result += resultSearchTransction(stt, value.user_name, value.nick_name, value.ip, value.agent, value.type, value.security, 0, value.time_log);
                        stt++
