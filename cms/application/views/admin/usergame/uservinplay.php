                ...
                <div class="formRow">
                    <table>
                        <tr>
                            ...
                            <td>
                                <input type="reset" onclick="window.location.href = '<?php echo admin_url('usergame/uservinplay') ?>'; " value="Reset" class="basic" style="margin-left: 20px">
                            </td>
                        </tr>
                    </table>
                </div>
...
<script>
    ...
    function resultSearchTransction(stt, username, nickname, vin, xu, safe, vippoint, vpsave, vpevent, recharge, date, googleid, facebookid, birthday, fbid, ggid) {
            ...
            success: function(result) {
                ...
                if (result.transactions == "") {
                    ...
                    $.each(result.transactions, function(index, value) {
                        result += resultSearchTransction(stt, value.username, value.nickname, value.vinTotal, value.xuTotal, value.safe, value.vippoint, value.vippointSave, 0, value.rechargeMoney, value.createTime, value.google_id, value.facebook_id, value.birthday, value.facebook_id, value.google_id);
                        stt++;
                    });
