        ...
        <div class="widget">
            ...
            <div class="formRow">
                <div class="row">
                    ...
                    <label class="col-sm-4" style="color: #e72929;word-break: break-all" id="errocode"><?php echo $error; ?>
                    </label>

                </div>
            </div>
            <div class="formRow">
                <form action="<?php echo admin_url("usergame/checkinfo") ?>" id="fileinfo" name="fileinfo" enctype="multipart/form-data" method="post">
                    <div class="row">
                        <div class="col-sm-1"></div>
                        <label class="col-sm-1 control-label" for="exampleInputEmail1">Tài khoản:</label>

                        <div class="col-sm-2">
                            <input type="file" id="userfile" name="filexls" value="<?php echo $this->input->post('filexls') ?>">
                        </div>
                        <div class="col-sm-1">
                            <input type="submit" class="btn btn-primary pull-left button blueB" id="upload" value="Upload" name="ok">
                        </div>
                    </div>
                </form>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-2">
                        <div class="input-group date" id="datetimepicker1">
                            <input type="text" id="fromDate" name="fromDate" class="form-control" value="<?php echo $start_time ?>">
                    ...
                    <div class="col-sm-2">
                        <div class="input-group date" id="datetimepicker2">
                            <input type="text" id="toDate" name="toDate" class="form-control" value="<?php echo $end_time ?>">
                            <span class="input-group-addon">
                                <span class="glyphicon glyphicon-calendar"></span>
                            </span>
                        </div>
    ...
    $("#openuser").click(function() {
        ...
        if ($("#listnickname").val() == "") {
            ...
            $.ajax({
                ...
                error: function() {
                    $("#spinner").hide();
                    $("#errocode").html("Hệ thống quá tải. Vui long thử lại sau");
                },
                timeout: 20000
            });
        }
