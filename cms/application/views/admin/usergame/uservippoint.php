                        ...
                        <tr>
                            ...
                            <?php else : ?>
                                <td class="item"><select id="typetaikhoan" name="typetaikhoan" style="margin-left: 5px;margin-bottom:-2px;width: 150px">
                                        ...
                                        <option value="2" <?php if ($this->input->post('typetaikhoan') == "2") {
                                                                echo "selected";
                                                            } ?>>Đại lý cấp 2</option>
                ...
                <div class="formRow">
                    <table>
                        <tr>
                            ...
                            <td><input type="text" style="margin-left: 40px;margin-bottom:-2px;width: 150px" id="phone" value="<?php echo $this->input->post('phone') ?>" name="phone"></td>
                ...
                <div class="formRow">
                    <table>
                        <tr>
                            ...
                            <td><select id="typetimkiem" name="typetimkiem" style="margin-left: 20px;margin-bottom:-2px;width: 150px">
                            ...
                            <td>
                                <input type="reset" onclick="window.location.href = '<?php echo admin_url('usergame/uservippoint') ?>'; " value="Reset" class="basic" style="margin-left: 20px">
                            </td>
                        </tr>
                    </table>
                </div>
