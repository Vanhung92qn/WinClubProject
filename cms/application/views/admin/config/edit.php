...
<?php if ($admin_info->Status == "A"): ?>
    <div class="title">
        <h4>Sửa config <span style="color: #7a6fbe"><?php echo $plat ?></span></h4>
    </div>
    ...
    <?php if ($plat == "ios" || $plat == "ad" || $plat == "web" || $plat == "wp"): ?>
        ...
        <div class="formRow">
            <div class="row">
                ...
                <div class="col-sm-1">
                    <label>Ip kho báu:</label>
                </div>
                <div class="col-sm-2">
                    <input type="text" class="form-control" id="txtipkb">
                </div>
                <div class="col-sm-1">
                    <label>Port kho báu:</label>
                </div>
                <div class="col-sm-2">
        ...
        <div class="formRow">
            <div class="row">
                <div class="col-sm-1">
                    <label>Status nữ điệp viên:</label>
                </div>
                <div class="col-sm-2">
                ...
                <div class="col-sm-1">
                    <label>Ip nữ điệp viên:</label>
                </div>
                <div class="col-sm-2">
                    <input type="text" class="form-control" id="txtipndv">
                </div>
                <div class="col-sm-1">
                    <label>Port nữ điệp viên:</label>
                </div>
                <div class="col-sm-2">
        ...
        <div class="formRow">
            <div class="row">
                <div class="col-sm-1">
                    <label>Status xizach:</label>
                </div>
                <div class="col-sm-2">
                    <select id="txtstatusxizach">
                        <option value="0">Running</option>
                        <option value="1">Maintain</option>
                        <option value="2">Disable</option>
                    </select>
                ...
                <div class="col-sm-1">
                    <label>Ip xizach:</label>
                </div>
                <div class="col-sm-2">
                    <input type="text" class="form-control" id="txtipxizach">
                </div>
                <div class="col-sm-1">
                    <label>Port xizach:</label>
                </div>
                <div class="col-sm-2">
                    <input type="text" class="form-control" id="txtportxizach">
                </div>
            </div>
        </div>
        ...
        <div class="formRow">
            <div class="row">
                ...
                <div class="col-sm-1">
                    <label>Ip xóc đĩa:</label>
                </div>
                <div class="col-sm-2">
                    <input type="text" class="form-control" id="txtipxoc">
                </div>
                <div class="col-sm-1">
                    <label>Port xóc đĩa:</label>
                </div>
                <div class="col-sm-2">
        ...
        <div class="formRow">
            <div class="row">
                <div class="col-sm-1">
                    <label>Status caro:</label>
                </div>
                <div class="col-sm-2">
                    <select id="txtstatuscaro">
                        <option value="0">Running</option>
                        <option value="1">Maintain</option>
                        <option value="2">Disable</option>
                    </select>
                ...
                <div class="col-sm-2">
                    <input type="text" class="form-control" id="txtipcaro">
                </div>
                <div class="col-sm-1">
                    <label>Port caro:</label>
                </div>
                <div class="col-sm-2">
                    <input type="text" class="form-control" id="txtportcaro">
                </div>
            </div>
        </div>
        ...
        <div class="formRow">
            <div class="row">
                <div class="col-sm-1">
                    <label>Status coup:</label>
                </div>
                <div class="col-sm-2">
                    <select id="txtstatuscoup">
                        <option value="0">Running</option>
                        <option value="1">Maintain</option>
                        <option value="2">Disable</option>
                    </select>
                ...
                <div class="col-sm-2">
                    <input type="text" class="form-control" id="txtipcoup">
                </div>
                <div class="col-sm-1">
                    <label>Port coup:</label>
                </div>
                <div class="col-sm-2">
                    <input type="text" class="form-control" id="txtportcoup">
                </div>
            </div>
        </div>
        ...
        <div class="formRow">
            <div class="row">
                <div class="col-sm-1">
                    <label>Status cotuong:</label>
                </div>
                <div class="col-sm-2">
                    <select id="txtstatuscotuong">
                        <option value="0">Running</option>
                        <option value="1">Maintain</option>
                        <option value="2">Disable</option>
                    </select>
                ...
                <div class="col-sm-1">
                    <label>Ip cotuong:</label>
                </div>
                <div class="col-sm-2">
                    <input type="text" class="form-control" id="txtipcotuong">
                </div>
                <div class="col-sm-1">
                    <label>Port cotuong:</label>
                </div>
                <div class="col-sm-2">
                    <input type="text" class="form-control" id="txtportcotuong">
                </div>
                <div class="col-sm-1">
...
<div class="row">
    ...
    elseif ($plat == "vin_plus"): ?>
        ...
        <div class="formRow">
            <div class="row">
                <h3 style="color: #7a6fbe;margin-left: 20px">IOS</h3>
            </div>
        </div>
        <div class="formRow">
            <div class="row">
        ...
        <div class="formRow">
            <div class="row">
                <h3 style="color: #7a6fbe;margin-left: 20px">Android</h3>
            </div>
        </div>
        <div class="formRow">
            <div class="row">
        ...
        <div class="formRow">
            <div class="row">
                <h3 style="color: #7a6fbe;margin-left: 20px">Window phone</h3>
            </div>
        </div>
        <div class="formRow">
            <div class="row">
        ...
        <div class="formRow">
            <div class="row">
                <h3 style="color: #7a6fbe;margin-left: 20px">Gold</h3>
            </div>
        </div>
        <div class="formRow">
            <div class="row">
        ...
        <div class="formRow">
            <div class="row">
                <h3 style="color: #7a6fbe;margin-left: 20px">Platinum</h3>
            </div>
        </div>
        <div class="formRow">
            <div class="row">
        ...
        <div class="formRow">
            <div class="row">
                <h3 style="color: #7a6fbe;margin-left: 20px">Diamond</h3>
            </div>
        </div>
        <div class="formRow">
            <div class="row">
...
$("#search_tran").click(function () {
    ...
    $.ajax({
        ...
        data: {
            ...
            txtstatusxizach: $("#txtstatusxizach").val(),
            txtipxizach: $("#txtipxizach").val(),
            txtportxizach: $("#txtportxizach").val(),
            txtstatuscotuong: $("#txtstatuscotuong").val(),
            txtipcotuong: $("#txtipcotuong").val(),
            txtportcotuong: $("#txtportcotuong").val(),
            txtstatuscoup: $("#txtstatuscoup").val(),
            txtipcoup: $("#txtipcoup").val(),
            txtportcoup: $("#txtportcoup").val(),
            txtstatuscaro: $("#txtstatuscaro").val(),
            txtipcaro: $("#txtipcaro").val(),
            txtportcaro: $("#txtportcaro").val(),
        ...
        $.ajax({
            ...
            success: function (result) {
                ...
                if ($("#configpf").val() == "ios" || $("#configpf").val() == "ad" || $("#configpf").val() == "web" || $("#configpf").val() == "wp") {
                    ...
                    $("#txtstatusxizach").val(obj.xizach.status);
                    $("#txtipxizach").val(obj.xizach.ip);
                    $("#txtportxizach").val(obj.xizach.port);
                    $("#txtstatuscotuong").val(obj.cotuong.status);
                    $("#txtipcotuong").val(obj.cotuong.ip);
                    $("#txtportcotuong").val(obj.cotuong.port);
                    $("#txtstatuscoup").val(obj.coup.status);
                    $("#txtipcoup").val(obj.coup.ip);
                    $("#txtportcoup").val(obj.coup.port);
                    $("#txtstatuscaro").val(obj.caro.status);
                    $("#txtipcaro").val(obj.caro.ip);
                    $("#txtportcaro").val(obj.caro.port);
                    $("#txtstatusxoc").val(obj.xocdia.status);
                    $("#txtipxoc").val(obj.xocdia.ip);
                    $("#txtportxoc").val(obj.xocdia.port);
