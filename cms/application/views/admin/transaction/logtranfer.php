            ...
            <div class="formRow">
                ...
                <table>
                    <tr>
                        ...
                        <td><label style="margin-left: 27px;margin-bottom:-2px;width: 100px">Giao dịch:</label></td>
                        <td><select id="typegd" name="typegd"
                                style="margin-left: 20px;margin-bottom:-2px;width: 145px;">
                                <option value="1" <?php if($this->input->post("typegd") == "1"){echo "selected";}  ?>>
                                    Chuyển vin</option>
                                <option value="2" <?php if($this->input->post("typegd") == "2"){echo "selected";}  ?>>
                                    Nhận vin</option>
                            </select></td>
...
function resultSearchTransction(stt, username, nickname, servicename, action, description, currentmoney, moneyexchange,
    fee, time) {
    var rs = "";
    rs += "<tr>";
    rs += "<td>" + stt + "</td>";
        ...
        success: function(result) {
            ...
            if (result.transactions == "") {
                ...
                $.each(result.transactions, function(index, value) {
                    result += resultSearchTransction(stt, value.userName, value.nickName,
                        value.actionName, value.serviceName, value.description, value
                        .currentMoney, value.moneyExchange, value.fee, value
                        .transactionTime);
                    stt++;
