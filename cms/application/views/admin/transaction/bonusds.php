            ...
            <div class="modal-dialog modal-sm">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <p style="color: #7a6fbe">SUCCESS</p>
                    </div>
...
<script>
    ...
    function resultSumTransaction(doanhso,ds2,bonusfix,bonusfix2,bonusmore,bonusmore2,bonusvin,bonusvincard,bonustotal){
        var rs = "";
        rs += "<tr>";
        rs += "<td colspan='2' style='color: #7a6fbe'>" + "Tổng" + "</td>";
        rs += "<td style='color: #7a6fbe'>" + commaSeparateNumber(doanhso) + "</td>";
        rs += "<td style='color: #7a6fbe'>" + commaSeparateNumber(bonusfix) + "</td>";
        rs += "<td style='color: #7a6fbe'>" + commaSeparateNumber(bonusmore) + "</td>";
        rs += "<td>" + "" + "</td>";
        rs += "<td style='color: #7a6fbe'>" + commaSeparateNumber(ds2) + "</td>";
        rs += "<td style='color: #7a6fbe'>" + commaSeparateNumber(bonusfix2) + "</td>";
        rs += "<td style='color: #7a6fbe'>" + commaSeparateNumber(bonusmore2) + "</td>";
        rs += "<td style='color: #7a6fbe'>" + commaSeparateNumber(bonustotal) + "</td>";
        rs += "</tr>";
        return rs;
