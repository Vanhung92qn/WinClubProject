...
<script>
    ...
    $(document).ready(function () {
            ...
            success: function (result) {
                ...
                if (result.listPercentBonus == "") {
                    ...
                    $(".rate").each(function (index, value) {
                        ...
                        $("#txtratio" + index).on('paste', function (e) {
        ...
        $('.form-control.ratio').on('paste', function (e) {
            let pastedData = e.originalEvent.clipboardData.getData('text');
            let money = parseInt(pastedData);
            if(isNaN(money) || money <= 0) {
                alert("Vui lòng nhập số lớn hơn 0");
...
<script>
    ...
    function resultSearchTransction(stt, nickname, ratio) {
        ...
        rs += "<td>" + '<input class="form-control ratio" style="font-size: 18px;color:blue; width:200px;display:inline" id="txtratio' + stt + '" type="text" value="' + ratio + '">' + "<span style='color: #7a6fbe;margin-left: 10px'>%</span>" + "</td>";
