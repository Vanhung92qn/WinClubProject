...
<script>
    ...
    function resultSumTransaction(fee1, ratio1, fee2, ratio2, fee2khac, ratio2khac, feevin, feevincard, fee) {
        ...
        rs += "<td style='color: #7a6fbe'>" + commaSeparateNumber(fee1) + "</td>";
        rs += "<td style='color: #7a6fbe'>" + (ratio1 * 100) + "%" + "</td>";
        rs += "<td style='color: #7a6fbe'>" + commaSeparateNumber(fee2) + "</td>";
        rs += "<td style='color: #7a6fbe'>" + (ratio2 * 100) + "%" + "</td>";
        rs += "<td style='color: #7a6fbe'>" + commaSeparateNumber(fee2khac) + "</td>";
        rs += "<td style='color: #7a6fbe'>" + (ratio2khac * 100) + "%" + "</td>";
