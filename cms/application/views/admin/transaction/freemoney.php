<title>Lịch Sử Đóng Băng Tiền</title>
<div class="titleArea">
    <div class="wrapper">
        <div class="pageTitle">
        </div>
                ...
                <div class="formRow">
                    ...
                    <table>
                        <tr>
                            ...
                            <td class="">
                                <select id="namegame" name="namegame" style="margin-left: 0px;margin-bottom:-2px;width: 143px">
                                    ...
                                    <option value="FreezeMoneyTranferAgent" <?php if ($this->input->post('namegame') == "FreezeMoneyTranferAgent") {
                                                                                echo "selected";
                                                                            } ?>>Đại lý đóng băng </option>

                                </select>
                            </td>
                            <td><label style="margin-left: 50px;margin-bottom:-2px;width: 100px">Loại tiền:</label></td>
                            <td class="">
                                <select id="money_type" name="money_type" style="margin-left: 0px;margin-bottom:-2px;width: 143px">
                                    <option value="vin" <?php if ($this->input->post('money_type') == "vin") {
                                                            echo "selected";
                                                        } ?>>Win</option>
                                    <option value="xu" <?php if ($this->input->post('money_type') == "xu") {
                                                            echo "selected";
                                                        } ?>>Xu</option>
                ...
                <div class="formRow">
                    ...
                    <table>
                        <tr>
                            ...
                            <td>
                                <input type="reset" onclick="window.location.href = '<?php echo admin_url('transaction/freemoney') ?>'; " value="Reset" class="basic" style="margin-left: 20px">
                            </td>
