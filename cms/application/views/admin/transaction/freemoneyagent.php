                ...
                <div class="formRow">
                    ...
                    <table>
                        <tr>
                            ...
                            <td class="item"><select id="statusdb" name="statusdb" style="margin-left: 27px;margin-bottom:-2px;width: 142px">
                            ...
                            <td>
                                <input type="reset" onclick="window.location.href = '<?php echo admin_url('transaction/freemoneyagent') ?>'; " value="Reset" class="basic" style="margin-left: 20px">
                            </td>
                        </tr>
