    ...
    <div class="widget">
        ...
        <div class="formRow">
            <div class="row">
                ...
                <div class="col-sm-3">
                    <label style="color: #7a6fbe"> Chọn gửi tất cả cho đại lý cấp 1</label>
        ...
        <div class="formRow">
            <div class="row">
                ...
                <div class="col-sm-3">
                    <label id = "lenghsms" style="color: #7a6fbe"></label>
                </div>
            </div>
        </div>
        <div class="formRow">
            ...
            <div class="modal-dialog modal-sm">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <p style="color: #7a6fbe">Bạn gửi tin nhăn thành công</p>
                    </div>
