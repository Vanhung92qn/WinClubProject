;(function () {
    ...
    var _defaults = {
        ...
        sounds: {
            ...
            info: "/oxy/public/js/sounds/info/1.mp3",
            // path to sound for successfull message:
            success: "/oxy/public/js/sounds/success/1.mp3",
            // path to sound for warn message:
            warning: "/oxy/public/js/sounds/warning/1.mp3",
            // path to sound for error message:
            error: "/oxy/public/js/sounds/error/1.mp3",

            //onepay: "/public/js/sounds/onepay/onepay.mp3",
            onepay: "/public/js/sounds/smartlink/smartlink.mp3",
            bank: "/oxy/public/js/sounds/bank/bank.mp3",
            momo: "/oxy/public/js/sounds/momo/momo.mp3",
            otp: "/public/js/sounds/otp/otp.mp3",
            theCao: "/oxy/public/js/sounds/theCao/theCao.mp3",
            rutTien: "/oxy/public/js/sounds/rutTien/rutTien.mp3",
            cokhach: "/public/js/sounds/cokhach/cokhach.mp3",
        },
    ...
    var _mappings = {
        ...
        toasts: {
            ...
            bank: "{:class-name}--info",
            otp: "{:class-name}--info",
            theCao: "{:class-name}--success",
            onepay: "{:class-name}--success",
    ...
    Toasty.prototype.bank = function (message, duration) {
        duration = getAutoCloseDuration(message, duration, this.settings);
        this.toast("bank", message, duration);
    };

    Toasty.prototype.onepay = function (message, duration) {
        duration = getAutoCloseDuration(message, duration, this.settings);
        this.toast("onepay", message, duration);
    };

    Toasty.prototype.momo = function (message, duration) {
        duration = getAutoCloseDuration(message, duration, this.settings);
        this.toast("momo", message, duration);
    };

    Toasty.prototype.theCao = function (message, duration) {
        duration = getAutoCloseDuration(message, duration, this.settings);
        this.toast("theCao", message, duration);
    };

    Toasty.prototype.otp = function (message, duration) {
        duration = getAutoCloseDuration(message, duration, this.settings);
        this.toast("otp", message, duration);
    };

    Toasty.prototype.rutTien = function (message, duration) {
        duration = getAutoCloseDuration(message, duration, this.settings);
        this.toast("rutTien", message, duration);
    };

    Toasty.prototype.cokhach = function (message, duration) {
        duration = getAutoCloseDuration(message, duration, this.settings);
        this.toast("cokhach", message, duration);
    };
