...
export default class PopupHistory extends Dialog {
    ...
    private loadData() {
        Http.get(Configs.App.API, { "c": 137, "p": this.page, "un": Configs.Login.Nickname, "gn": GameName.HALLOWEEN}, (err, res) => {
            if (err != null) return;
            ...
            for (let i = 0; i < this.items.length; i++) {
                ...
                if (i < res["results"].length) {
                    ...
                    clickEventHandler.component = "SlotHalloween.PopupHistory";
    ...
    setupIconById(nodeItem, id) {
        let skeleton = nodeItem.getComponentInChildren(sp.Skeleton);
        switch(id) {
            case 0:
                skeleton.setAnimation(0, "Scatter", true);
                break;
            case 1:
                skeleton.setAnimation(0, "Bonus", true);
                break;
            case 2:
                skeleton.setAnimation(0, "Wild", true);
                break;
            case 3:
                skeleton.setAnimation(0, "Jackpot", true);
                break;
            case 4:
                skeleton.setAnimation(0, "Non", true);
                break;
            case 5:
                skeleton.setAnimation(0, "Mo", true);
                break;
            case 6:
                skeleton.setAnimation(0, "Zombie", true);
                break;
            case 7:
                skeleton.setAnimation(0, "Sach", true);
                break;
            case 8:
                skeleton.setAnimation(0, "Meo", true);
                break;
            case 9:
                skeleton.setAnimation(0, "Noi", true);
                break;
            case 10:
                skeleton.setAnimation(0, "DenCay", true);
                break;
        }
    }
