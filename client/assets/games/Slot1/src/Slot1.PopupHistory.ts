...
export default class PopupHistory extends Dialog {
    ...
    show() {
        ...
        this.scrollViewHistory.scrollToTop(.1);
    }
    ...
    private loadData() {
        Http.get(Configs.App.API, { "c": 137, "p": this.page, "un": Configs.Login.Nickname, "gn": GameName.LIEN_MINH}, (err, res) => {
            if (err != null) return;
            ...
            for (let i = 0; i < this.items.length; i++) {
                ...
                if (i < res["results"].length) {
                    ...
                    clickEventHandler.component = "Slot1.PopupHistory";
