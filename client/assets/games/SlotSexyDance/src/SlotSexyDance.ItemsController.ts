...
@ccclass
export default class SlotSexyDanceItemsController extends ItemController {

    @property(cc.Boolean)
    isLSC = true;

    protected onLoad() {
        this.showAnimCallBack = this.animItemsSexyDance.bind(this);
    }

    animItemsSexyDance(delayTime, isLoop = false, itemPrefix) {
                                    ...
                                    if(this.spinNode && this.id < 3) {
                                        switch (this.serverID) {
                                            ...
                                            case 1:
                                                ...
                                                break;
                                            case 3:
                                                this.mapAnimWithID(2, "animation", 1 ,delayTime, isLoop);
                                                break;
                                        }
                                    }
                                }),
