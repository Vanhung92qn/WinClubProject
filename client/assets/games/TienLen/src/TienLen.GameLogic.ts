...
import GameData from "../../../scripts/games/GameData"
...
export default class TienLenGameLogic {
    ...
    initReconnect(a) {
        ...
        this.cardChiabai = [];
        cc.log("cardChidBai size" + a.cards.length);
        for (var b = 0; b < a.cards.length; b++) this.cardChiabai.push(a.cards[b]), cc.log("carChiabai " + a.cards[b]);
        ...
        for (var b = 0; b < GameData.getInstance().maxPlayer; b++) {
            ...
            0 != a.playerStatus[b] && (cc.log("playI: " + b + " " + c), this.players[c].ingame = !0, this.players[c].active = !0, this.players[c].info = a.playerInfos[b], cc.log("pkPlayerInfos" + a.playerInfos[b].nickName), this.players[c].status = a.playerStatus[b], this.players[c].chairInServer = b, this.players[c].chairLocal = c);
        }
    }
    ...
    firstTurn(a) {
        ...
        for (b = 0; b < TienLenConstant.Config.MAX_PLAYER; b++) cc.log("this.firstTurn: " + b + " " + this.firstTurnCards[b]);
    }
