...
export namespace cmd {
    export class Code {
        ...
        static LOG_CHAT = 17003;
        static SEND_CHAT = 17000;
        static SCRIBE_CHAT = 17001;
        static UNSCRIBE_CHAT = 17002;
    }
    ...
    export class ReceiveUpdateTime extends InPacket {
        ...
        constructor(data: Uint8Array) {
            ...
            this.moneyhu = this.getLong();
            this.hasPlainTextResult = this.getBool();
            this.md5TextResult = this.getString();
            this.plainTextResult = this.getString();
        }
    }
