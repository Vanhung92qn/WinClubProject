...
import TaiXiuMiniController from "../../TaiXiuDouble/TaiXiuMini/src/TaiXiuMini.TaiXiuMiniController";
                    ...
                    case cmd.Code.SEND_CHAT: {
                        ...
                        switch (res.error) {
                            case 0:
                                ...
                                break;
                            case 2:
                                TaiXiuMD5Controller.instance.showToast("Bạn không có quyền Chat!");
                                break;
                            case 3:
                                TaiXiuMD5Controller.instance.showToast("Tạm thời bạn bị cấm Chat!");
                                break;
                            case 4:
                                TaiXiuMD5Controller.instance.showToast(`${ToastMessage.TAI_XIU_CHAT_TOO_LONG}`);
                                break;
                            case 5:
                                TaiXiuMD5Controller.instance.showToast(`${ToastMessage.TAI_XIU_CHAT_CHAT_FAST}`);
                                break;
                            case 6:
                                TaiXiuMD5Controller.instance.showToast(`${ToastMessage.TAI_XIU_CHAT_TOO_LONG}`);
                                break;
                            case 7:
                                TaiXiuMD5Controller.instance.showToast(`Cần tối thiểu ${Utils.formatNumber(this.minRequireToChat)} để chat`);
                                break;
                            default:
                                TaiXiuMD5Controller.instance.showToast(`${ToastMessage.TAI_XIU_CHAT_CHAT_FAST}`);
                                break;
