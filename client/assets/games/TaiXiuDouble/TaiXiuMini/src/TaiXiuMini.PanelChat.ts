                    ...
                    case cmd.Code.SEND_CHAT: {
                        ...
                        switch (res.error) {
                            case 0:
                                ...
                                break;
                            case 2:
                                TaiXiuMiniController.instance.showToast("Bạn không có quyền Chat!");
                                break;
                            case 3:
                                TaiXiuMiniController.instance.showToast("Tạm thời bạn bị cấm Chat!");
                                break;
                            case 4:
                                TaiXiuMiniController.instance.showToast(`${ToastMessage.TAI_XIU_CHAT_TOO_LONG}`);
                                break;
                            case 5:
                                TaiXiuMiniController.instance.showToast(`${ToastMessage.TAI_XIU_CHAT_CHAT_FAST}`);
                                break;
                            case 6:
                                TaiXiuMiniController.instance.showToast(`${ToastMessage.TAI_XIU_CHAT_TOO_LONG}`);
                                break;
                            case 7:
                                TaiXiuMiniController.instance.showToast(`Cần tối thiểu ${Utils.formatNumber(this.minRequireToChat)} để chat`);
                                break;
                            default:
                                TaiXiuMiniController.instance.showToast(`${ToastMessage.TAI_XIU_CHAT_CHAT_FAST}`);
                                break;
