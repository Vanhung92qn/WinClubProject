...
export default class BaiCaoController extends cc.Component {
    ...
    startNothingActionCountDown(turnTime) {
        cc.log("BaiCao startNothingCountDown turnTime : ", turnTime);
    ...
    processNothing(rate) {
        cc.log("BaiCao processDoNothing rate : ", rate);
        cc.log("BaiCao processDoNothing fillRange : ", this.notifyTimeNothing.children[0].getComponent(cc.Sprite).fillRange);
        ...
        BaiCaoNetworkClient.getInstance().addListener((data) => {
            ...
            switch (inpacket.getCmdId()) {
                case cmd.Code.LOGIN:
                    ...
                    cc.log("BaiCao Login res:", inpacket.getCmdId());
                    this.refeshListRoom();
                ...
                case cmd.Code.GET_LIST_ROOM:
                    {
                        ...
                        cc.log("BaiCao ReceivedListRoom res: ", JSON.stringify(res));
                ...
                case cmd.Code.JOIN_ROOM_SUCCESS:
                    {
                        ...
                        cc.log("BaiCao ReceivedJoinRoom res: ", JSON.stringify(res));
                        this.closeUIRoom();
                        this.setupMatch(res);
                    }
                    break;
