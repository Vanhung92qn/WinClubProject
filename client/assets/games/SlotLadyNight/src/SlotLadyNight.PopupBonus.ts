...
export class PopupBonus extends Dialog {
        ...
        for (let i = 0; i < this.listItem.length; i++) {
            ...
            nodeItem.on(cc.Node.EventType.TOUCH_END, () => {
                ...
                if(this.left > 0) {
                    ...
                    SlotLadyNightController.getInstance().playSoundSlapBooty();
                    nodeAnim.setAnimation(0, "girl_0" + (i+1) + "_chon", true);
                    nodeItem.runAction(
                        cc.sequence(
                            cc.delayTime(.5),
                            cc.callFunc(() => {
                                ...
                                moneyPrefab.position = nodeItem.position;
                            ...
                            cc.delayTime(.8),
                            cc.callFunc(() => {
                                nodeAnim.setAnimation(0, "girl_0" + (i + 1) + "_Grey", true);
                            })
                        )
                    )
                }
    ...
    showBonus(bonus: string, onFinished: () => void) {
        ...
        for (let i = 0; i < this.listItemAnim.length; i++) {
            ...
            animItem.setAnimation(0, "girl_0" + (i+1)+"_idle", true);
        }
    ...
    showTotalRewardBonus(totalReward = 0) {
        ...
        SlotLadyNightSlotLNController.getInstance().playSoundFinishedNotif();
