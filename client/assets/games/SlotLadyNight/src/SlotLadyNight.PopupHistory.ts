...
export default class PopupHistory extends Dialog {
    ...
    private loadData() {
        Http.get(Configs.App.API, { "c": 137, "p": this.page, "un": Configs.Login.Nickname, "gn": GameName.LADY_NIGHT}, (err, res) => {
            if (err != null) return;
            ...
            for (let i = 0; i < this.items.length; i++) {
                ...
                if (i < res["results"].length) {
                    ...
                    clickEventHandler.component = "SlotLadyNight.PopupHistory";
    ...
    setupIconById(nodeItem, id, columnIndex) {
        ...
        switch(id) {
            ...
            case 14:
                sprite.active = true;
                nodeSkeleton.active = false;
                sprite.getComponent(cc.Sprite).spriteFrame = this.spriteAtlasIcon.getSpriteFrame('symbol_1_14');
                break;
        }
    }
