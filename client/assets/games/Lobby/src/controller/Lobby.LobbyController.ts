...
import PopupManager, { PopupTier } from "../../../scripts/common/PopupManager";
...
namespace Lobby {
    ...
    export class LobbyController extends cc.Component {
        ...
        // popupTransaction: removed @property — now lazy-loaded via PopupManager
        ...
        @property(cc.Node)
        nodeLobby = null;
        // Tier 2+3 popup prefabs: removed @property — now lazy-loaded via PopupManager
        // popupProfile, popupShop, prefabMailBox, prefabPopupCashOut,
        // prefabPopupCashOutTransaction, prefabPopupCashOutGuide, prefabPopupEvent,
        // popupSecurity, prefabPopupForgetPassword, prefabPopupSetting,
        // prefabPopupGiftCode, prefabPopupUpdateCashoutBank, prefabPopupChargeTransaction,
        // prefabPopupChargeGuide, popupActiveTelegram, prefabPopupSafe,
        // prefabPopupTelegramGuide, prefabPopupBigBanner, prefabPopupUpdateNickName
        ...
        protected onLoad() {
            ...
            // Register all lazy-loaded popups with PopupManager
            // Tier 2 — STANDARD: lazy load, cache prefab after first load
            PopupManager.instance.register('PopupProfile', { prefabPath: 'res/prefabs/PopupProfile', tier: PopupTier.STANDARD, isGlobal: false });
            PopupManager.instance.register('PopupShop', { prefabPath: 'res/prefabs/PopupShop', tier: PopupTier.STANDARD, isGlobal: true });
            PopupManager.instance.register('PopupMailBox', { prefabPath: 'res/prefabs/PopupTinTuc', tier: PopupTier.STANDARD, isGlobal: false });
            PopupManager.instance.register('PopupCashOut', { prefabPath: 'res/prefabs/PopupCashout', tier: PopupTier.STANDARD, isGlobal: true });
            PopupManager.instance.register('PopupTransaction', { prefabPath: 'res/prefabs/PopupTransaction', tier: PopupTier.STANDARD, isGlobal: false });
            PopupManager.instance.register('PopupSecurity', { prefabPath: 'res/prefabs/PopupTelegramSecurity', tier: PopupTier.STANDARD, isGlobal: false });
            PopupManager.instance.register('PopupForgetPassword', { prefabPath: 'res/prefabs/PopupForgetPassword', tier: PopupTier.STANDARD, isGlobal: false });
            PopupManager.instance.register('PopupSetting', { prefabPath: 'res/prefabs/PopupSetting', tier: PopupTier.STANDARD, isGlobal: true });
            PopupManager.instance.register('PopupUpdateNickName', { prefabPath: 'res/prefabs/PopupUpdateNickName', tier: PopupTier.STANDARD, isGlobal: false });
            PopupManager.instance.register('PopupBigBanner', { prefabPath: 'res/prefabs/PopupBigBanner', tier: PopupTier.STANDARD, isGlobal: false });

            // Tier 3 — RARE: lazy load, prefab released after popup closed
            PopupManager.instance.register('PopupCashOutTransaction', { prefabPath: 'res/prefabs/PopupGiaoDichRutBank', tier: PopupTier.RARE, isGlobal: true });
            PopupManager.instance.register('PopupCashOutGuide', { prefabPath: 'res/prefabs/PopupCashoutGuide', tier: PopupTier.RARE, isGlobal: true });
            PopupManager.instance.register('PopupEvent', { prefabPath: 'res/prefabs/PopupEvent', tier: PopupTier.RARE, isGlobal: false });
            PopupManager.instance.register('PopupGiftCode', { prefabPath: 'res/prefabs/PopupGiftCode', tier: PopupTier.RARE, isGlobal: false });
            PopupManager.instance.register('PopupUpdateCashoutBank', { prefabPath: 'res/prefabs/PopupUpdateBankCashout', tier: PopupTier.RARE, isGlobal: false });
            PopupManager.instance.register('PopupChargeTransaction', { prefabPath: 'res/prefabs/PopupGiaoDichNap', tier: PopupTier.RARE, isGlobal: true });
            PopupManager.instance.register('PopupChargeGuide', { prefabPath: 'res/prefabs/PopupShopGuide', tier: PopupTier.RARE, isGlobal: true });
            PopupManager.instance.register('PopupActiveTelegram', { prefabPath: 'res/prefabs/PopupCancelTelegram', tier: PopupTier.RARE, isGlobal: false });
            PopupManager.instance.register('PopupSafe', { prefabPath: 'res/prefabs/PopupKetSat', tier: PopupTier.RARE, isGlobal: false });
            PopupManager.instance.register('PopupTelegramGuide', { prefabPath: 'res/prefabs/PopupTelegramSecurityGuide', tier: PopupTier.RARE, isGlobal: false });
        }
        ...
        actCreatePopupShop(startTab) {
            ...
            PopupManager.instance.openPopup('PopupShop');
        }
        ...
        actOpenGiftCode() {
            ...
            PopupManager.instance.openPopup('PopupGiftCode');
        }
        ...
        actCashout() {
            ...
            PopupManager.instance.openPopup('PopupCashOut');
        }
        ...
        actOpenUserProfile() {
            PopupManager.instance.openPopup('PopupProfile', this.nodeLobby);
        }

        actOpenPopupTransaction() {
            PopupManager.instance.openPopup('PopupTransaction', this.nodeLobby);
        }
        ...
        actOpenMailBox() {
            PopupManager.instance.openPopup('PopupMailBox', this.nodeLobby);
        }

        actOpenCashOutTransaction() {
            PopupManager.instance.openPopup('PopupCashOutTransaction');
        }

        actOpenCashOutGuide() {
            PopupManager.instance.openPopup('PopupCashOutGuide');
        }

        actOpenChargeTransaction() {
            PopupManager.instance.openPopup('PopupChargeTransaction');
        }

        actOpenChargeGuide() {
            PopupManager.instance.openPopup('PopupChargeGuide');
        }

        actOpenPopupEvent() {
            PopupManager.instance.openPopup('PopupEvent', this.nodeLobby);
        }

        actOpenPopupForgetPassword() {
            PopupManager.instance.openPopup('PopupForgetPassword', this.nodeLobby);
        }
        ...
        actOpenPopupSecurity() {
            PopupManager.instance.openPopup('PopupSecurity', this.nodeLobby);
        }

        actOpenPopupActiveTelegram() {
            PopupManager.instance.openPopup('PopupActiveTelegram', this.nodeLobby);
        }

        actOpenPopupSetting() {
            PopupManager.instance.openPopup('PopupSetting');
        }
        ...
        actOpenPopupCashOutBank() {
            PopupManager.instance.openPopup('PopupUpdateCashoutBank', this.nodeLobby);
        }
        ...
        actOpenPopupSafe() {
            PopupManager.instance.openPopup('PopupSafe', this.nodeLobby);
        }

        actOpenPopupTelegramActiveGuide() {
            PopupManager.instance.openPopup('PopupTelegramGuide', this.nodeLobby);
        }
        ...
        actOpenBigBanner() {
            PopupManager.instance.openPopup('PopupBigBanner', this.nodeLobby);
        }
