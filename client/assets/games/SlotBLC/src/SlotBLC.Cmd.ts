...
export namespace cmd {
    export class Code {
        static SUBCRIBE = 7003;
        static UNSUBCRIBE = 7004;
        static CHANGE_ROOM = 7005;
        static PLAY = 7001;
        static UPDATE_POT = 7002;
        static AUTO = 7006;
        static FORCE_STOP_AUTO = 7008;
        static GAME_INFO = 7009;
        static BIG_WIN = 7010;
        static FREE = 7011;
        static FREE_DAI_LY = 7012;
        static MINIMIZE = 7013;
    }
