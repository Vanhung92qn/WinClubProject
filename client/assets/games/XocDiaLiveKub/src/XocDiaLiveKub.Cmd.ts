...
export namespace cmd {
    export class Code {
        ...
        static GET_LIST_USER = 3213;
        static GET_GAME_STATE = 3155;
    }
    ...
    export class SendGetListUser extends OutPacket {
        constructor() {
            super();
            this.initData(100);
            this.setControllerId(1);
            this.setCmdId(Code.GET_LIST_USER);
            this.packHeader();
            this.updateSize();
        }
    }
    export class ReceiveListUser extends InPacket {
    ...
    export class ReceiveJoinRoomSuccess extends InPacket {
        ...
        constructor(data: Uint8Array) {
            ...
            this.totalBetTime = this.getShort();
            this.remainBetTime = this.getShort();
    ...
    export class ReceiveGetCau extends InPacket {
        ...
        constructor(data: Uint8Array) {
            ...
            this.total3Black = this.getInt();
            this.total4Black = this.getInt();
            this.total3White = this.getInt();
            this.total4White = this.getInt();
        }
    }
    ...
    export class SendChatRoom extends OutPacket{
        constructor(isIcon: number, messageChat: string, chatOrTip: number, tipAmount: number) {
            super();
            this.initData(100);
            this.setControllerId(1);
            ...
            this.packHeader();
            this.putByte(isIcon);
            this.putString(encodeURI(messageChat));
            this.putShort(chatOrTip);
            this.putLong(tipAmount);
            this.updateSize();
        }
    }

    export class ReceiveGameState extends InPacket {
        gameState: number;
        time: number;
        sessionId: number;
        ...
        constructor(data: Uint8Array) {
            ...
            this.gameState = this.getByte();
            this.time = this.getByte();
            this.sessionId = this.getLong();
            this.livestreamUrl = this.getString();
        }
