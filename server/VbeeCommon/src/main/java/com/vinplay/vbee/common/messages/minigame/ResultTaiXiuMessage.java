...
public class ResultTaiXiuMessage extends BaseMessage {
    ...
    public ResultTaiXiuMessage(long referenceId, int result, int dice1, int dice2, int dice3, long totalTai, long totalXiu, int numBetTai, int numBetXiu, long totalPrize, long totalRefundTai, long totalRefundXiu, long totalRevenue, int moneyType, long moneyHu, int statusHu, String md5, String plaintText, long totalChan, long totalLe, int numBetChan, int numBetLe, long kubetSessionId) {
