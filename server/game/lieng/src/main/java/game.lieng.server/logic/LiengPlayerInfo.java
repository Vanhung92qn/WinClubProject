...
public class LiengPlayerInfo {
    ...
    public LiengPlayerInfo(GamePlayer gp) {
        this.gamePlayer = gp;
        this.clearOutGame();
    }
    ...
    public Turn takeTurn(LiengGameInfo potInfo, Round round) {
        boolean flag;
    ...
    public Turn fold(LiengGameInfo potInfo, Round round) {
    ...
    public Turn check(LiengGameInfo potInfo, Round round) {
    ...
    public Turn allIn(LiengGameInfo potInfo, Round round, long newMoneyBet) {
        ...
        this.listTurn.add(turn);
        this.allIn = true;
        long raiseAmmount = newMoneyBet - this.moneyBet;
        if (potInfo.lastRaise < raiseAmmount) {
            potInfo.lastRaise = raiseAmmount;
        }
    ...
    public Turn call(LiengGameInfo potInfo, Round round, long newMoneyBet) {
    ...
    public Turn raise(LiengGameInfo potInfo, Round round, long newMoneyBet) {
        long raiseAmmount;
        ...
        round.addTurn(turn);
        this.listTurn.add(turn);
        potInfo.lastRaise = raiseAmmount = newMoneyBet - this.moneyBet;
        this.moneyBet = newMoneyBet;
        potInfo.maxBetMoney = newMoneyBet;
        this.currentMoney -= this.registerMoney;
        this.registerMoney = 0L;
    ...
    public Turn take(LiengGameInfo potInfo, Round round, boolean isBlind) {
        boolean flag;
        ...
        if (!potInfo.raiseBlock && newMoneyBet >= potInfo.maxBetMoney + potInfo.bigBlindMoney && flag) {
            return this.raise(potInfo, round, newMoneyBet);
        }
        Debug.trace((Object[])new Object[]{"Raise invalid: moneyBet, registerMoney, potInfo.maxBetMoney, potInfo.bigBlindMoney, flag", this.moneyBet, this.registerMoney, potInfo.maxBetMoney, potInfo.bigBlindMoney, flag});
        return this.fold(potInfo, round);
    }
    ...
    public boolean register(RevTakeTurn cmd, LiengPlayerInfo info, LiengGameInfo potInfo) {
        ...
        if (cmd.raise > 0L) {
            if (cmd.raise + info.moneyBet < potInfo.maxBetMoney + (long)potInfo.bigBlind) {
