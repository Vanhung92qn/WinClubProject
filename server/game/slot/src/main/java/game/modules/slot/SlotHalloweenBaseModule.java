...
public abstract class SlotHalloweenBaseModule extends Slot25BasicModule {

    public SlotHalloweenBaseModule(String gameName) {
        super(gameName);
    }
    ...
    public void init() {
        ...
        this.rooms.put(this.gameName + "_vin_100",
                new SlotHalloweenRoom(this, this.commandCollection, slotLogListener, this.gameName, (byte) 0, this.gameName + "_vin_100", (short) 1, this.jackpots[0], funds[0], 100, initJackpotValues[0]));
        this.rooms.put(this.gameName + "_vin_1000",
                new SlotHalloweenRoom(this, this.commandCollection, slotLogListener, this.gameName, (byte) 1, this.gameName + "_vin_1000", (short) 1, this.jackpots[1], funds[1], 1000, initJackpotValues[1]));
        this.rooms.put(this.gameName + "_vin_10000",
                new SlotHalloweenRoom(this, this.commandCollection, slotLogListener, this.gameName, (byte) 2, this.gameName + "_vin_10000", (short) 1, this.jackpots[2], funds[2], 10000, initJackpotValues[2]));
