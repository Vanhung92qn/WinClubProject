...
public class SlotHalloweenLines extends Slot25BasicLines{
    private List<Line<SlotBasic25Item>> lines = new ArrayList<Line<SlotBasic25Item>>();

    public SlotHalloweenLines() {
        this.initLines();
    }
    ...
    private void initLines() {
        ...
        Line line22 = new Line("line22", 1, 0, 0, 1, 2, 2, 0, 3, 1, 4);
    ...
    public List<Line<SlotBasic25Item>> list() {
        return this.lines;
    }

    public Line<SlotBasic25Item> get(int index) {
