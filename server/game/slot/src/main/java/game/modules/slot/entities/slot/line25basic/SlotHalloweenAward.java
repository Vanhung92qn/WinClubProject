...
public enum SlotHalloweenAward {
    ...
    QUADAR_G("QUADAR_G", 15, (byte) 16, SlotBasic25Item.G, (byte) 4, 80.0f),
    TRIPLE_G("TRIPLE_G", 16, (byte) 17, SlotBasic25Item.G, (byte) 3, 20.0f),

    PENTA_F("PENTA_F", 17, (byte) 18, SlotBasic25Item.F, (byte) 5, 380.0f),
    ...
    TRIPLE_E("TRIPLE_E", 22, (byte) 23, SlotBasic25Item.E, (byte) 3, 14.0f),
    ...
    SlotHalloweenAward(String name, int index, byte id, SlotBasic25Item item, byte duplicate, float ratio) {
        this.id = id;
        this.item = item;
