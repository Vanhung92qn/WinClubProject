...
public class RangeRoverModule
    ...
    public void init() {
        ...
        this.rooms.put(this.gameName + "_vin_100", new RangeRoverRoom(this, (byte) 0, this.gameName + "_vin_100", (short) 1, this.jackpots[0], funds[0], 100, initPotValues[0]));
        this.rooms.put(this.gameName + "_vin_1000", new RangeRoverRoom(this, (byte) 1, this.gameName + "_vin_1000", (short) 1, this.jackpots[1], funds[1], 1000, initPotValues[1]));
        this.rooms.put(this.gameName + "_vin_5000", new RangeRoverRoom(this, (byte) 2, this.gameName + "_vin_5000", (short) 1, this.jackpots[2], funds[2], 5000, initPotValues[2]));
        this.rooms.put(this.gameName + "_vin_10000", new RangeRoverRoom(this, (byte) 3, this.gameName + "_vin_10000", (short) 1, this.jackpots[3], funds[3], 10000, initPotValues[3]));
...
//            SendMsgToAlLUsersThread t = new SendMsgToAlLUsersThread(this, msg);
    ...
    private void userDis(User user) {
        RangeRoverRoom room = (RangeRoverRoom) user.getProperty("MGROOM_" + this.gameName + "_INFO");
        if (room != null) {
            room.quitRoom(user);
    ...
    protected String getRoomName(short moneyType, long baseBetting) {
        ...
        return Games.RANGE_ROVER.getName() + "_" + moneyTypeStr + "_" + baseBetting;
    }
    ...
    protected void gameLoop() {
        ...
        if (this.countBot100 >= this.getCountTimeBot(this.gameName + "_bot_100")) {
            if (this.countBot100 == this.getCountTimeBot(this.gameName + "_bot_100")) {
                ...
                for (String bot : bots) {
                    ...
                    room = (RangeRoverRoom) this.rooms.get(Games.RANGE_ROVER.getName() + "_vin_100");
        ...
        if (this.countBot1000 >= this.getCountTimeBot(this.gameName + "_bot_1000")) {
            if (this.countBot1000 == this.getCountTimeBot(this.gameName + "_bot_1000")) {
                ...
                for (String bot : bots) {
                    if (bot == null) continue;
                    room = (RangeRoverRoom) this.rooms.get(Games.RANGE_ROVER.getName() + "_vin_1000");
                    room.play(bot, this.fullLines);
                }
            }
            this.countBot1000 = 0;
        ...
        if (this.countBot5000 >= this.getCountTimeBot(this.gameName + "_bot_5000")) {
            if (this.countBot5000 == this.getCountTimeBot(this.gameName + "_bot_5000")) {
                ...
                for (String bot : bots) {
                    if (bot == null) continue;
                    room = (RangeRoverRoom) this.rooms.get(Games.RANGE_ROVER.getName() + "_vin_5000");
                    room.play(bot, this.fullLines);
                }
            }
            this.countBot5000 = 0;
        ...
        if (this.countBot10000 >= this.getCountTimeBot(this.gameName + "_bot_10000")) {
            if (this.countBot10000 == this.getCountTimeBot(this.gameName + "_bot_10000")) {
                ...
                for (String bot : bots) {
                    if (bot == null) continue;
                    room = (RangeRoverRoom) this.rooms.get(Games.RANGE_ROVER.getName() + "_vin_10000");
                    room.play(bot, this.fullLines);
                }
            }
