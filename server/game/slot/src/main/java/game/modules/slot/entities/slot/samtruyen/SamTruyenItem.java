...
public enum SamTruyenItem {
    ...
    private SamTruyenItem(String s, int n2, String name, byte id) {
        this.name = name;
        this.id = id;
    }
    ...
    public static SamTruyenItem findItem(byte id) {
        for (SamTruyenItem entry : SamTruyenItem.values()) {
