...
public class TaiXiuUtils {
    private static Logger loggerTaiXiu = Logger.getLogger((String)"csvBetOverUnder");
    ...
    private static void rewardThanhDu(String startTime, String endTime, short type) throws SQLException {
        ...
        OverUnderDAOImpl txDAO = new OverUnderDAOImpl();
    ...
    private static long rewardThanhDuToUser(ThanhDuTXModel entry, long prize, String actionName) {
        ...
        Calendar cal = Calendar.getInstance();
        cal.add(5, -1);
        MoneyResponse response = userService.updateMoney(entry.username, prize, "vin", "OverUnder", "Th\u00c3\u00a1nh D\u00e1\u00bb\u00b1 - Tr\u00e1\u00ba\u00a3 th\u00c6\u00b0\u00e1\u00bb\u0178ng", "Ng\u00c3\u00a0y " + format.format(cal.getTime()), 0L, null, TransType.NO_VIPPOINT);
