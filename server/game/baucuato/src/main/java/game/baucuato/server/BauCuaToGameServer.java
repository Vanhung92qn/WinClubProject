...
public class BauCuaToGameServer
extends GameServer {
    ...
    implements Runnable {
        ...
        public void run() {
            try {
                BauCuaToGameServer.this.botLoop();
            }
            catch (Exception e) {
                Debug.trace((Object)e);
            }
    ...
    implements Runnable {
        ...
        public void run() {
            try {
                BauCuaToGameServer.this.bossLoop();
            }
            catch (Exception e) {
                Debug.trace((Object)e);
            }
    ...
    implements Runnable {
        ...
        public void run() {
            try {
                BauCuaToGameServer.this.gameLoop();
            }
            catch (Exception e) {
                Debug.trace((Object)e);
            }
