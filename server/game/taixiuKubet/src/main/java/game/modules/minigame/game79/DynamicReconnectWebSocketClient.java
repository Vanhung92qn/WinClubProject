...
public class DynamicReconnectWebSocketClient extends WebSocketClient {
    ...
    private static final String BASE_URI = "wss://dicelive.79club3.win/dicelive/signalr/connect?connectionToken=";
    ...
    public static URI buildDynamicURI() {
        ...
        try {
            String getUrl = "https://dicelive.79club3.win/dicelive/signalr/negotiate?cp=R&cl=R&pf=web";
