...
public class GroupCard
    ...
    public byte[] haituquyLonNhat() {
        ...
        for (int i = this.cards.size() - 1; i >= 3; --i) {
            if (this.getCardAt((int) i).SO != this.getCardAt((int) (i - 1)).SO || this.getCardAt((int) i).SO != this.getCardAt((int) (i - 2)).SO || this.getCardAt((int) i).SO != this.getCardAt((int) (i - 3)).SO)
                continue;
            if (soTuQuy == 0) {
    ...
    public byte[] baLonNhat() {
        ...
        for (int i = this.cards.size() - 1; i >= 2; --i) {
            if (this.getCardAt((int) i).SO != this.getCardAt((int) (i - 1)).SO || this.getCardAt((int) i).SO != this.getCardAt((int) (i - 2)).SO)
                continue;
