...
public class BauCuaUtils {
    ...
    public static void rewardToiChonCa() {
        ...
        for (int i = 0; i < list.size() && i < prizes.length; ++i) {
            ...
            MoneyResponse response = userService.updateMoney(player.username, prizes[i], "vin", "BauCuaTo", "T\u00c3\u00b4i ch\u00e1\u00bb\ufffdn c\u00c3\u00a1 - Tr\u00e1\u00ba\u00a3 th\u00c6\u00b0\u00e1\u00bb\u0178ng", "Ng\u00c3\u00a0y " + yesterday, 0L, null, TransType.NO_VIPPOINT);
