...
public class RutBanhXuLy {
    ...
    public synchronized boolean InsertRutBankMomo(InfoMomoEnity info) {
        MongoDatabase db = MongoDBConnectionFactory.getDB();
        MongoCollection col = db.getCollection("RutBankMomo");
        Document doc = new Document();
    ...
    public InfoMomoEnity GetRutBankMomo(String nickName) {
        ArrayList<InfoMomoEnity> list_Info = new ArrayList<>();
    ...
    public synchronized boolean deleteSTK(String nickname) {
        MongoDatabase db = MongoDBConnectionFactory.getDB();
        MongoCollection col = db.getCollection("RutBankSTK");
