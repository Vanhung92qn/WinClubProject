...
//        logger.debug("4026" + " enroll on 4026");
        ...
        if (userService.checkAccesstoken(nickname, accessToken)) {
            ...
            long checkTimeBan = aceMoneyService.getBanWithdrawTime(nickname);
//                return "{\"code\":0,\"message\":null,\"currentBalanceGame\":0.0,\"data\":\"\"}";
            try {
                ...
                e.printStackTrace();
                ghilog(nickname, accessToken, e.getMessage() + " Chỗ này rollback sicbo", "123123");
    ...
    private String getRequest(DepositRequestEntity depositRequest) throws IOException {
        ...
        try {
            ...
            Request request = new Request.Builder()
                    .url("https://xingxing.bandoluuniem.net/sicbo/deposit?brand=sunvin")
                    .method("POST", body)
