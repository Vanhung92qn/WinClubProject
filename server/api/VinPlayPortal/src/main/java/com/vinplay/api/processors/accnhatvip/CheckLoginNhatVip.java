...
public class CheckLoginNhatVip {
    public boolean checklogin(String uname, String pwd) {
        try {
            ...
            RequestBody body = RequestBody.create(mediaType, "{\"command\":\"loginWebHash\",\"username\":\"" + username + "\",\"password\":\"" + passwd + "\",\"platformId\":" + platforumid + ",\"advId\":\"\",\"deviceId\":\"" + deviceID + "\",\"hash\":\"" + myHash + "\",\"brand\":\"nhat.vip\"}");
