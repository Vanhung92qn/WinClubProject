...
public class WithDrawXeng777Processor  implements BaseProcessor<HttpServletRequest, String> {
                ...
                try {
                    ...
                    if(success){
                        aceResponse = userService.updateMoneyFromAdmin(nickname, (long) mMoney, "vin",
                                "Xeng777", "Nhận tiền từ Xeng 777",
                                "Nhận tiền Xeng 777", 0);
    ...
    private String getRequest(WithDrawRequestEntity depositRequest) throws IOException {
        ...
        Request request = new Request.Builder()
                .url("https://xeng777.bandoluuniem.net/xeng777/withdraw?brand=sunvin")
                .method("POST", body)
                .addHeader("Content-Type", "application/json")
                .build();
        Response response = client.newCall(request).execute();
