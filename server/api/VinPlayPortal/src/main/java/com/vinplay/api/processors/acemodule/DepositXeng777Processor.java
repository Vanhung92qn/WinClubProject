...
public class DepositXeng777Processor  implements BaseProcessor<HttpServletRequest, String> {
            ...
            if (userService.checkAccesstoken(nickname, accessToken)) {
                ...
                try {
                    ...
                    aceResponse = userService.updateMoneyFromAdmin(nickname, (long) -mMoney, "vin",
                            "Xeng777", "Chuyển tiền Xeng 777",
                            "Chuyển tiền Xeng 777", 0);
...
//                                    "Xeng777", "Chuyển tiền Xeng 777 thất bại",
//                                    "Chuyển tiền Xeng 777 thất bại", 0);
                            BroadCastUserMoney.pushBroadCast(nickname);
                        }else {
...
//                        userService.updateMoneyFromAdmin(nickname, (long) mMoney, "vin",
//                                "Xeng777", "Rollback tiền xèng 777",
//                                "Rollback tiền xèng 777", 0);
                    }
    ...
    private String getRequest(DepositRequestEntity depositRequest) throws IOException {
        ...
        Request request = new Request.Builder()
                .url("https://xeng777.bandoluuniem.net/xeng777/deposit?brand=sunvin")
                .method("POST", body)
