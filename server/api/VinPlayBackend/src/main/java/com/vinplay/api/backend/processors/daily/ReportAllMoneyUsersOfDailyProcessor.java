...
public class ReportAllMoneyUsersOfDailyProcessor
    ...
    public String execute(Param<HttpServletRequest> param) {
        ...
        block15:
        {
            ...
            try {
                ...
                long safeMoney = 0L;
                long totalMoney = 0L;
                currentMoney = dao.getCurrentMoneyAllUsersByDaily(nickname);
                safeMoney = dao.getSafeMoneyAllUsersByDaily(nickname);
