...
import com.vinplay.api.backend.processors.rutbank.CallAutoTransBank2;
...
public class CashOutByBank2Processor implements BaseProcessor<HttpServletRequest, String> {
...
//                }
                ...
                if (status.equals(CashoutUtil.STATUS_SENDING)) {
                    ...
                    CallAutoTransBank2 callBank = new CallAutoTransBank2();
