...
import com.vinplay.api.backend.processors.rutbank.CallAutoTransBank3;
...
public class CashOutByBank3Processor implements BaseProcessor<HttpServletRequest, String> {
...
//                }
                ...
                if (status.equals(CashoutUtil.STATUS_SENDING)) {
                    ...
                    CallAutoTransBank3 callBank = new CallAutoTransBank3();
