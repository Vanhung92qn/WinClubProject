...
public class SetBotFakeTaiXiuProcessor implements BaseProcessor<HttpServletRequest, String> {
  ...
  public String execute(Param<HttpServletRequest> param) {
    ...
    try {
      ...
      cacheService.setObject("taixiu_bot_fake_amount", taiXiuSetAmountBotFake);
      return "1";
    } catch (Exception e) {
