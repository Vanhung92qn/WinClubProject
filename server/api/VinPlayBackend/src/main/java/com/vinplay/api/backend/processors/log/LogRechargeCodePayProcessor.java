...
public class LogRechargeCodePayProcessor implements BaseProcessor<HttpServletRequest, String> {
    ...
    public String execute(Param<HttpServletRequest> param) {
        ...
        try {
            ...
            res = dao.GetListDepositCodepay(modelSearch, page, maxItem, startTime, endTime);
