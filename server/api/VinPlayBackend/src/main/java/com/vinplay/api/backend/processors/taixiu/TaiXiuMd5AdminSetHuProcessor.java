...
public class TaiXiuMd5AdminSetHuProcessor implements BaseProcessor<HttpServletRequest, String> {
    @Override
    public String execute(Param<HttpServletRequest> param) {
        ...
        try {
            ...
            if (max > min) {
                cacheService.setValue("min_hu_tx_auto_md5", min + "");
                cacheService.setValue("max_hu_tx_auto_md5", max + "");
                if (huTx == 99) {
