 ...
 *  com.vinplay.dichvuthe.response.LogSMS8x98Response
...
implements BaseProcessor<HttpServletRequest, String> {
    ...
    public String execute(Param<HttpServletRequest> param) {
        ...
        LogSMS8x98Response res = new LogSMS8x98Response(false, "1001");
        try {
            String nickname = request.getParameter("nn");
            String mobile = request.getParameter("m");
            String amounts = request.getParameter("am");
            String shortCode = request.getParameter("sc");
            ...
            if (nickname != null && mobile != null && amounts != null && shortCode != null && requestId != null && codes != null && startTime != null && endTime != null && pages != null) {
                ...
                res = dao.getLogSMS8x98(nickname, mobile, amount, shortCode, requestId, code, startTime, endTime, page);
            }
        }
        catch (Exception e) {
