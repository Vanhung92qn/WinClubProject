...
public class UpdateBankDLmuaban implements BaseProcessor<HttpServletRequest, String> {
    public String execute(Param<HttpServletRequest> param) {
        ...
        try {
            ...
            bankdlEntity daily = new bankdlEntity(id,dlid, bank, bankname, banknum, chinhanh);
            SaveDLMuaBan savedl = new SaveDLMuaBan();
            savedl.UpdateBankDL(daily);
