 ...
 *  com.vinplay.dichvuthe.response.LogSMSPlusResponse
...
public class LogRechargeSMSPlusProcessor
implements BaseProcessor<HttpServletRequest, String> {
    private static final Logger logger = Logger.getLogger((String)"backend");

    public String execute(Param<HttpServletRequest> param) {
        HttpServletRequest request = (HttpServletRequest)param.get();
        LogSMSPlusResponse res = new LogSMSPlusResponse(false, "1001");
        try {
            ...
            if (nickname != null && mobile != null && amounts != null && requestId != null && codes != null && startTime != null && endTime != null && pages != null) {
                ...
                res = dao.getLogSMSPlus(nickname, mobile, amount, requestId, code, startTime, endTime, page);
            }
        }
        catch (Exception e) {
