...
import com.vinplay.api.backend.processors.rutbank.CallAutoTransBank4;
...
public class CashOutByBank4Processor implements BaseProcessor<HttpServletRequest, String> {
