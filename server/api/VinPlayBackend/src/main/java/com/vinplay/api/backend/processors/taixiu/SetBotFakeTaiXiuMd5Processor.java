...
public class SetBotFakeTaiXiuMd5Processor implements BaseProcessor<HttpServletRequest, String> {
  ...
  public String execute(Param<HttpServletRequest> param) {
    ...
    try {
      ...
      cacheService.setObject("taixiu_bot_fake_amount_md5", taiXiuSetAmountBotFake);
      return "1";
    } catch (Exception e) {
