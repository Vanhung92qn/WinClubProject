...
public class SaveTransactionXocDiaKubetProcessor
    ...
    public Boolean execute(Param<byte[]> param) {
        ...
        try {
            ...
            XocDiaKubetDaoImpl dao = new XocDiaKubetDaoImpl();
    ...
    public void addTopVinhDanh(TransactionXocDiaMessage message) {
        try {
            ...
            topVinhDanhDto.setBoardName(Games.XOC_DIA_KUBET.getName());
