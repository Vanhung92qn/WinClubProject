...
public class NapTienGaClient {
    ...
    public JSONObject doCharge(String cardType, String pin, String seri, String transId,long amount,
        ...
        String napTienGaApiKey = PartnerConfig.NapTienGaApiKey;
        if(clientName != null && clientName.equals("V"))
            napTienGaApiKey = PartnerConfig.NapTienGaApiKeyVip52;
        RechargeServiceImpl.logger.debug("napTienGaApiKey:"+napTienGaApiKey);
        Debug.trace("napTienGaApiKey:"+napTienGaApiKey);

        String endpoint = "http://hub.12c.biz:10004/api/SIM/RegCharge?apiKey="+ napTienGaApiKey +"&code="+ pin +"&serial="+ seri +"&type="+ sCardType +"&menhGia="+ amount +"&requestId=" + transId;
    ...
    private boolean validateCharge(String cardType, String pin, String seri) throws GachTheException {
        ...
        if (!Arrays.asList("vtt", "vnp", "vm").contains(cardType)) {
