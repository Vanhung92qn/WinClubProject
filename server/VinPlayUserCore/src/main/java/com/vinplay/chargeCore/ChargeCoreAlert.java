...
public class ChargeCoreAlert {
    public static int disconnect = 0;
    public static Date alertDisconnectTime = new Date();
    ...
    public static int vinPending = 0;
    ...
    public static Date alertVinPendingTime = new Date();
}
