...
implements Serializable {
    ...
    private static TypeDesc typeDesc = new TypeDesc(CheckTransResult.class, true);

    public CheckTransResult() {
    }

    public CheckTransResult(int errorCode, String message) {
    ...
    static {
        typeDesc.setXmlType(new QName("http://services.epay", "CheckTransResult"));
