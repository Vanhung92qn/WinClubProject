    ...
    public List<MoneyTotalRechargeByCardReponse> moneyTotalRechargeBySmsPlus9029(String timeStart, String timeEnd, String code) {
        ...
        iterable.forEach((Block)new Block<Document>(){
            ...
            public void apply(Document document) {
                ...
                rechargeBySmsPlus9029DAOImpl.totalMoney = rechargeBySmsPlus9029DAOImpl.totalMoney + (long)document.getInteger((Object)"amount").intValue();
                block7 : switch (RechargeBySmsPlus9029DAOImpl.mapProviderByTarget(document.getString((Object)"mobile"))) {
                    case "Viettel": {
                        RechargeBySmsPlus9029DAOImpl rechargeBySmsPlus9029DAOImpl2 = RechargeBySmsPlus9029DAOImpl.this;
                        rechargeBySmsPlus9029DAOImpl2.viettelMoney = rechargeBySmsPlus9029DAOImpl2.viettelMoney + (long)document.getInteger((Object)"amount").intValue();
                    ...
                    case "Vinaphone": {
                        ...
                        rechargeBySmsPlus9029DAOImpl3.vinaphoneMoney = rechargeBySmsPlus9029DAOImpl3.vinaphoneMoney + (long)document.getInteger((Object)"amount").intValue();
                        switch (document.getInteger((Object)"amount")) {
                            case 100000: {
                    ...
                    case "Mobifone": {
                        ...
                        rechargeBySmsPlus9029DAOImpl4.mobifoneMoney = rechargeBySmsPlus9029DAOImpl4.mobifoneMoney + (long)document.getInteger((Object)"amount").intValue();
                        switch (document.getInteger((Object)"amount")) {
                            case 100000: {
                    ...
                    case "VietNamMobile": {
                        ...
                        rechargeBySmsPlus9029DAOImpl5.vietNamMobileMoney = rechargeBySmsPlus9029DAOImpl5.vietNamMobileMoney + (long)document.getInteger((Object)"amount").intValue();
                        switch (document.getInteger((Object)"amount")) {
                            case 100000: {
                    ...
                    case "GMobile": {
                        ...
                        rechargeBySmsPlus9029DAOImpl6.gMobileMoney = rechargeBySmsPlus9029DAOImpl6.gMobileMoney + (long)document.getInteger((Object)"amount").intValue();
                        switch (document.getInteger((Object)"amount")) {
                            case 100000: {
    ...
    public List<RechargeBySmsResponse> exportDataRechargeBySmsPlus(String timeStart, String timeEnd, String amount, String code) {
        ...
        iterable.forEach((Block)new Block<Document>(){
            ...
            public void apply(Document document) {
                ...
                bank.provider = RechargeBySmsPlus9029DAOImpl.mapProviderByTarget(document.getString((Object)"mobile"));
                results.add(bank);
            }
        });
        return results;
